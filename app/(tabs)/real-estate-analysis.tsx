...
const S = StyleSheet.create({
  ...
  sectionTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "900", marginBottom: 4 },
  ...
  areaPsm: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  roiLabel: { fontSize: 16, fontWeight: "900" },
  roiTotal: { fontSize: 16, fontWeight: "900" },
  roiDetails: { gap: 4 },
  ...
  ctaBtnText: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
});
