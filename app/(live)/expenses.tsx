...
const S = StyleSheet.create({
  ...
  catFilter: { overflow: "hidden", flexDirection: "row", alignItems: "center", gap: 5, borderRadius: RADIUS.full, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  catFilterText: { ...TYPE.caption, color: BRAND.textMuted },

  expCard: { overflow: "hidden", borderRadius: RADIUS.xl, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", flexDirection: "row", alignItems: "flex-start", padding: 14, gap: 12 },
  ...
  personCard: { overflow: "hidden", borderRadius: RADIUS.xl, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", flexDirection: "row", alignItems: "center", padding: 14, gap: 12 },
  ...
  catBreakdownBar: { flex: 1, height: 6, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 3, overflow: "hidden" },
  ...
  modalHandle: { width: 40, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.06)", alignSelf: "center", marginBottom: 20 },
  modalTitle: { ...TYPE.h2, color: BRAND.textPrimary, marginBottom: 20 },
  input: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: RADIUS.xl, paddingHorizontal: 16, paddingVertical: 14, ...TYPE.body, color: BRAND.textPrimary, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", marginBottom: 12 },
  ...
  catChip: { overflow: "hidden", flexDirection: "row", alignItems: "center", gap: 6, borderRadius: RADIUS.full, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
