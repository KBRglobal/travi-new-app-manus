        ...
        renderItem={({ item, section }) => (
          <View>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={[S.checkbox, item.checked && S.checkboxChecked, { borderColor: item.checked ? section.color : "rgba(255,255,255,0.2)" }]}>
...
const S = StyleSheet.create({
  ...
  progressWrap: { paddingHorizontal: 16, paddingBottom: 16, gap: 6 },
  ...
  addItemInput: { flex: 1, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 10, padding: 10, color: "#FFF", fontSize: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.1)" },
