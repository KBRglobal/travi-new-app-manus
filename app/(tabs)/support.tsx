...
const F = StyleSheet.create({
  ...
  faqA: { color: "rgba(255,255,255,0.6)", fontSize: 13, lineHeight: 20 },
  ...
  emailLabel: { color: "rgba(255,255,255,0.4)", fontSize: 13 },
  ...
  emailBtnText: { color: "#C084FC", fontSize: 13, fontWeight: "600" },
});
...
const C = StyleSheet.create({
  wrap: { gap: 12 },
  sectionTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", marginBottom: 4 },
  fieldLabel: { color: "rgba(255,255,255,0.55)", fontSize: 12, fontWeight: "700", letterSpacing: 0.5, marginBottom: -4 },
  input: { backgroundColor: "rgba(255,255,255,0.07)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", padding: 13, color: "#FFFFFF", fontSize: 14 },
  ...
  successTitle: { color: "#FFFFFF", fontSize: 24, fontWeight: "900" },
  successDesc: { color: "rgba(255,255,255,0.55)", fontSize: 14, lineHeight: 21, textAlign: "center" },
  ...
  ticketId: { color: "#C084FC", fontSize: 22, fontWeight: "900", marginTop: 4 },
});
...
const TK = StyleSheet.create({
  ...
  count: { color: "rgba(255,255,255,0.35)", fontSize: 13 },
  ...
  ticketSubject: { color: "#FFFFFF", fontSize: 14, fontWeight: "600", lineHeight: 20 },
  ...
  emptyDesc: { color: "rgba(255,255,255,0.45)", fontSize: 13, textAlign: "center", lineHeight: 19 },
});
...
const S = StyleSheet.create({
  ...
  headerBadgeText: { color: "#22C55E", fontSize: 12, fontWeight: "800" },
