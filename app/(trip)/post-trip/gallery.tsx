...
export default function GalleryScreen() {
 ...
 <FlatList
 ListEmptyComponent={() => <EmptyState emoji="camera" title="No photos yet" description="Add memories from your trip." />} data={PHOTOS} numColumns={3} keyExtractor={i => i.id} contentContainerStyle={{ padding: 4 }} renderItem={({ item }) => (
