...
const CONVERSATIONS = [
 ...
 { id: '2', name: 'Mike R.', avatar: 'person', lastMessage: 'The hiking trail was amazing', time: '1h', unread: 0, online: false },
 { id: '3', name: 'Barcelona Trip Group', avatar: '', lastMessage: 'Emma: I booked the restaurant', time: '3h', unread: 5, online: true },
 { id: '4', name: 'Emma L.', avatar: 'person‍', lastMessage: 'Thanks for the recommendation!', time: '1d', unread: 0, online: true },
 { id: '5', name: 'David W.', avatar: 'person', lastMessage: 'Photo attached', time: '2d', unread: 0, online: false },
];
