...
const styles = StyleSheet.create({
  ...
  stepCircleText: { color: "#FFFFFF", fontSize: 12, fontWeight: "800" },
  ...
  stepTitle: { color: "#FFFFFF", fontSize: 22, fontWeight: "900", textAlign: "center" },
  stepDesc: { color: "rgba(255,255,255,0.5)", fontSize: 14, textAlign: "center", lineHeight: 22 },
  inputGroup: { gap: 8 },
  inputLabel: { color: "rgba(255,255,255,0.6)", fontSize: 13, fontWeight: "700" },
  input: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, color: "#FFFFFF", fontSize: 15, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  uploadTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  ...
  selfieTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
  ...
  tipTitle: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  reviewSectionTitle: { color: "rgba(255,255,255,0.5)", fontSize: 12, fontWeight: "800", textTransform: "uppercase", letterSpacing: 1 },
  reviewRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  reviewLabel: { color: "rgba(255,255,255,0.5)", fontSize: 14 },
  ...
  successDesc: { color: "rgba(255,255,255,0.5)", fontSize: 14, textAlign: "center", lineHeight: 22 },
  ...
  successStepText: { color: "rgba(255,255,255,0.5)", fontSize: 14 },
