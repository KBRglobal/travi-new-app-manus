...
const styles = StyleSheet.create({
  ...
  stepCounter: { color: "rgba(255,255,255,0.4)", fontSize: 12, fontWeight: "700", textAlign: "center" },
  ...
  skipText: { color: "rgba(255,255,255,0.4)", fontSize: 12, fontWeight: "600" },
  content: { flex: 1 },
  scrollContent: { paddingHorizontal: 20 },
  stepHeader: { alignItems: "center", paddingTop: 16, paddingBottom: 24, gap: 10 },
  stepIconWrap: { width: 64, height: 64, borderRadius: 32, alignItems: "center", justifyContent: "center" },
  stepIcon: { fontSize: 32 },
  stepTitle: { color: "#FFFFFF", fontSize: 24, fontWeight: "900", textAlign: "center" },
  stepSubtitle: { color: "rgba(255,255,255,0.55)", fontSize: 15, textAlign: "center", lineHeight: 22 },
  ...
  optionLabel: { color: "rgba(255,255,255,0.9)", fontSize: 14, fontWeight: "800" },
  ...
  sliderValue: { fontSize: 24, fontWeight: "900" },
  sliderTrack: { flexDirection: "row", alignItems: "center", gap: 16 },
  sliderDot: { width: 20, height: 20, borderRadius: 10, backgroundColor: "rgba(255,255,255,0.15)" },
  sliderDotActive: { width: 28, height: 28, borderRadius: 14 },
  sliderLabels: { flexDirection: "row", justifyContent: "space-between", width: "80%" },
  sliderLabelText: { color: "rgba(255,255,255,0.4)", fontSize: 13 },
  sliderHint: { color: "rgba(255,255,255,0.35)", fontSize: 13, textAlign: "center", lineHeight: 20, paddingHorizontal: 20 },
