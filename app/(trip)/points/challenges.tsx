...
const CHALLENGES = [
  ...
  { id: '2', emoji: '🍽️', title: 'Local Foodie', desc: 'Try 5 local restaurants', reward: 300, progress: 3, total: 5, active: true, expires: '3 days' },
  { id: '3', emoji: '📸', title: 'Photo Master', desc: 'Upload 10 trip photos', reward: 200, progress: 10, total: 10, active: false, expires: 'Completed' },
  { id: '4', emoji: '🚶', title: 'City Walker', desc: 'Walk 20km in a city', reward: 400, progress: 0, total: 20, active: true, expires: '7 days' },
  { id: '5', emoji: '⭐', title: 'Review Pro', desc: 'Write 3 detailed reviews', reward: 350, progress: 2, total: 3, active: true, expires: '10 days' },
  { id: '6', emoji: '🤝', title: 'Social Traveler', desc: 'Connect with 5 travelers', reward: 250, progress: 5, total: 5, active: false, expires: 'Completed' },
];
