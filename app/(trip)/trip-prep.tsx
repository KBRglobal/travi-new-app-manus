...
const styles = StyleSheet.create({
  ...
  headerCenter: { flex: 1 },
  headerTitle: { color: "#1A0B2E", fontSize: 17, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  progressBar: { height: 3, backgroundColor: "rgba(255,255,255,0.06)", marginHorizontal: 20 },
  progressFill: { height: "100%", backgroundColor: "#6443F4", borderRadius: 2 },
  tabs: { flexDirection: "row", marginHorizontal: 20, marginTop: 16, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, padding: 4 },
  ...
  catChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  catChipTextActive: { color: "#1A0B2E" },
  addItemRow: { flexDirection: "row", gap: 10, marginBottom: 14 },
  addItemInput: { flex: 1, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, color: "#1A0B2E", fontSize: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  addItemBtnText: { color: "#1A0B2E", fontSize: 24, fontWeight: "700", fontFamily: "Chillax-Semibold" },
  checkItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 12, paddingHorizontal: 14, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  checkItemDone: { opacity: 0.5 },
  checkBox: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: "rgba(255,255,255,0.12)", alignItems: "center", justifyContent: "center", marginTop: 1 },
  checkMark: { color: "#1A0B2E", fontSize: 12, fontWeight: "900", fontFamily: "Chillax-Bold" },
  checkItemContent: { flex: 1, gap: 4 },
  checkItemText: { color: "#1A0B2E", fontSize: 14, fontWeight: "600", lineHeight: 20 },
  ...
  allDoneTitle: { color: "#1A0B2E", fontSize: 20, fontWeight: "900", fontFamily: "Chillax-Bold" },
  allDoneSub: { color: "rgba(255,255,255,0.5)", fontSize: 14, textAlign: "center" },
  // Services
  sectionTitle: { color: "#1A0B2E", fontSize: 16, fontWeight: "800", marginBottom: 6, fontFamily: "Chillax-Bold" },
  ...
  serviceTitle: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  visaDestination: { color: "#1A0B2E", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  docItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)" },
  docIcon: { fontSize: 24, marginTop: 2 },
  docInfo: { flex: 1, gap: 4 },
  docTitleRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  docTitle: { color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
  ...
  emergencyItem: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)" },
