...
const CARDS = [
 ...
 { id: '2', name: 'Mike R.', avatar: 'person', dna: 'Adventure · Nature', match: 87, bio: 'Hiking enthusiast, always looking for the next summit', trips: 12 },
 { id: '3', name: 'Emma L.', avatar: 'person‍', dna: 'Luxury · Wellness', match: 78, bio: 'Spa lover, boutique hotels, fine dining', trips: 5 },
];
