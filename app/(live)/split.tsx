...
const styles = StyleSheet.create({
  ...
  balanceAvatar: { fontSize: 24, fontFamily: "Satoshi-Regular" },
  balanceName: { fontSize: 12, fontFamily: "Chillax-Semibold", color: "#E5E7EB", fontWeight: "600" },
  balanceAmount: { fontSize: 16, fontFamily: "Chillax-Bold", fontWeight: "800" },
  positiveBalance: { color: "#34D399" },
  negativeBalance: { color: "#F87171" },
  settledBadge: { flexDirection: "row", alignItems: "center", gap: 3 },
  settledText: { fontSize: 11, fontFamily: "Chillax-Semibold", color: "#34D399", fontWeight: "600" },
  expenseCard: {
  ...
  memberChipAvatar: { fontSize: 12, fontFamily: "Satoshi-Regular" },
  memberChipName: { fontSize: 11, fontFamily: "Satoshi-Regular", color: "#D1D5DB" },
  owedBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  owedText: { fontSize: 13, fontFamily: "Chillax-Semibold", fontWeight: "600" },
  ...
  input: { flex: 1, fontSize: 16, fontFamily: "Satoshi-Regular", color: "#F9FAFB", paddingVertical: 14 },
  dollarSign: { fontSize: 20, fontFamily: "Chillax-Bold", fontWeight: "800", color: "#A78BFA", marginRight: 6 },
  amountInput: { fontSize: 24, fontFamily: "Chillax-Bold", fontWeight: "800" },
  ...
  perPersonText: { fontSize: 14, fontFamily: "Chillax-Semibold", color: "#A78BFA", fontWeight: "600" },
  ...
  addExpenseBtnText: { fontSize: 16, fontFamily: "Chillax-Semibold", fontWeight: "700", color: "#fff" },
});
