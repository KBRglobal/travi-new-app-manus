...
const ACHIEVEMENTS = [
  ...
  { name: '5 Continents', icon: '🌍', unlocked: true },
  { name: '100 Activities', icon: '🏆', unlocked: false, progress: '78/100' },
  { name: 'Night Owl', icon: '🦉', unlocked: true },
  { name: 'Foodie', icon: '🍜', unlocked: false, progress: '12/20' },
];
    ...
    <View className="flex-1 bg-bg-primary">
      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="flex-row justify-around mb-6">
          {[['🌍', '23', 'Countries'], ['🏙️', '67', 'Cities'], ['✈️', '41', 'Flights'], ['📸', '1,204', 'Photos']].map(([icon, num, label]) => (
