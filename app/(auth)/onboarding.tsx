...
const styles = StyleSheet.create({
  ...
  skipBtn: { position: "absolute", top: 60, right: 24, zIndex: 10, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.12)" },
  ...
  title: { color: "#FFFFFF", fontSize: 40, fontWeight: "900", lineHeight: 48, marginBottom: 16 },
  subtitle: { color: "rgba(255,255,255,0.75)", fontSize: 17, lineHeight: 26 },
