...
const S = StyleSheet.create({
  ...
  inviteCard: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.04)" },
  ...
  inviteAvatarText: { color: "#A78BFA", fontSize: 18, fontWeight: "900" },
  inviteInfo: { flex: 1, gap: 2 },
  inviteName: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  inviteDna: { color: "rgba(255,255,255,0.4)", fontSize: 12 },
  ...
  input: { backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", paddingHorizontal: 14, paddingVertical: 12, color: "#FFFFFF", fontSize: 14 },
  ...
  sentText: { color: "#22C55E", fontSize: 14, fontWeight: "800" },
  linkCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", paddingHorizontal: 14, paddingVertical: 12 },
