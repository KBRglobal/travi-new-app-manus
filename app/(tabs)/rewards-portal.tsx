...
const styles = StyleSheet.create({
  ...
  balanceValue: { color: "#1A0B2E", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  balanceBtnText: { color: "#1A0B2E", fontSize: 12, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  tierInfo: { flex: 1 },
  tierName: { color: "#1A0B2E", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  tierRowInfo: { flex: 1 },
  tierRowName: { color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
  ...
  referTitle: { color: "#1A0B2E", fontSize: 16, fontWeight: "800", textAlign: "center", fontFamily: "Chillax-Bold" },
  ...
  referCode: { color: "#1A0B2E", fontSize: 16, fontWeight: "900", flex: 1, letterSpacing: 1, fontFamily: "Chillax-Bold" },
  copyBtn: { backgroundColor: "rgba(100,67,244,0.3)", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  copyBtnText: { color: "#1A0B2E", fontSize: 12, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  rewardTitle: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  redeemBtnText: { color: "#1A0B2E", fontSize: 12, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  txInfo: { flex: 1 },
  txDesc: { color: "#1A0B2E", fontSize: 14, fontWeight: "600", fontFamily: "Satoshi-Medium" },
