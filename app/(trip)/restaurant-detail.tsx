...
const styles = StyleSheet.create({
  ...
  heroRating: { color: "#FFFFFF", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  menuCategoryTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 10, paddingBottom: 130, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)", fontFamily: "Chillax-Bold" },
  ...
  menuItemPrice: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ratingOverview: { alignItems: "center", paddingVertical: 20, gap: 4 },
  ratingBig: { color: "#FFFFFF", fontSize: 48, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  reserveLabel: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 12, fontFamily: "Chillax-Bold" },
  ...
  reserveBtnText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", fontFamily: "Chillax-Bold" },
  reservedCard: { alignItems: "center", paddingVertical: 40, gap: 10 },
  reservedEmoji: { fontSize: 56 },
  reservedTitle: { color: "#FFFFFF", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
