...
const S = StyleSheet.create({
  ...
  headerBadgeText: { color: "#22C55E", fontSize: 13, fontWeight: "800" },
  headerTitle: { color: "#FFFFFF", fontSize: 26, fontWeight: "900", lineHeight: 32 },
  headerSub: { color: "rgba(255,255,255,0.5)", fontSize: 14, lineHeight: 20 },
  ...
  cardSubtitle: { color: "rgba(255,255,255,0.45)", fontSize: 12 },
  ...
  cardDesc: { color: "rgba(255,255,255,0.55)", fontSize: 13, lineHeight: 19 },
  ...
  featureText: { color: "rgba(255,255,255,0.5)", fontSize: 11, flex: 1 },

  cardPriceRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  cardPrice: { color: "#FFFFFF", fontSize: 20, fontWeight: "900" },
  cardPricePer: { color: "rgba(255,255,255,0.4)", fontSize: 13, fontWeight: "500" },
  ...
  summaryLabel: { color: "rgba(255,255,255,0.4)", fontSize: 12 },
  ...
  skipBtnText: { color: "rgba(255,255,255,0.5)", fontSize: 15, fontWeight: "700" },
