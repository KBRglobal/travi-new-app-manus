...
export default function HomeScreen() {
 ...
 <Text style={{ fontFamily: fonts.bold, fontSize: fontSizes.bodySm, color: colors.primary }}>Nomad Mode globe</Text>
 </View>
 </TouchableOpacity>
 </View>
 <TouchableOpacity
 ...
 {[
 { label: 'New Trip', iconName: 'airplane', route: '/(trip)/plan/destination' },
 { label: 'My Trips', iconName: 'clipboard', route: '/(tabs)/home/trips' },
 { label: 'Explore', iconName: 'globe', route: '/(tabs)/explore' },
 { label: 'Wallet', iconName: 'cash', route: '/(tabs)/wallet' },
 ].map(action => (
 <TouchableOpacity
 key={action.label}
 onPress={() => {
