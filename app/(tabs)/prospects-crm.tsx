...
const styles = StyleSheet.create({
  ...
  stageName: { flex: 1, color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  stageCount: { color: "rgba(255,255,255,0.5)", fontSize: 13, marginRight: 4 },
  ...
  prospectAvatarText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  prospectInfo: { flex: 1 },
  ...
  prospectValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
  stageTag: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  stageTagText: { fontSize: 10, fontWeight: "800" },
  ...
  contactAvatarText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  contactInfo: { flex: 1 },
  ...
  contactValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
  analyticsTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 14 },
  analyticsRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 12 },
  analyticsDot: { width: 10, height: 10, borderRadius: 5 },
  analyticsStage: { color: "rgba(255,255,255,0.7)", fontSize: 13, width: 90 },
  ...
  marketDeals: { color: "rgba(255,255,255,0.5)", fontSize: 13, marginRight: 12 },
  marketValue: { color: "#22C55E", fontSize: 14, fontWeight: "800" },
  // Detail styles
  ...
  detailAvatarText: { color: "#FFFFFF", fontSize: 24, fontWeight: "900" },
  detailName: { color: "#FFFFFF", fontSize: 20, fontWeight: "900" },
  detailRole: { color: "rgba(255,255,255,0.6)", fontSize: 14 },
  detailCountry: { color: "rgba(255,255,255,0.4)", fontSize: 13 },
  ...
  dealValueAmount: { color: "#FFFFFF", fontSize: 32, fontWeight: "900" },
