...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: "row", alignItems: "center", gap: 10, marginHorizontal: 20, marginBottom: 12, backgroundColor: "rgba(255,255,255,0.07)", borderRadius: RADIUS.md, paddingHorizontal: 14, paddingVertical: 10, borderWidth: 1, borderColor: BRAND.border },
  ...
  cardContent: { flexDirection: "row", gap: 14, padding: 14 },
  ...
  destChip: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, backgroundColor: "rgba(255,255,255,0.07)" },
  destText: { ...TYPE.caption, color: BRAND.textSecondary },
  cardFooter: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 14, paddingBottom: 12, paddingTop: 4 },
