...
export default function ReviewScreen() {
 ...
 {[
 { key: 'overall' as const, label: 'Overall Experience', iconName: 'star' },
 { key: 'flights' as const, label: 'Flights', iconName: 'airplane' },
 { key: 'hotel' as const, label: 'Hotel', iconName: 'bed' },
 { key: 'activities' as const, label: 'Activities', iconName: 'flag' },
 { key: 'food' as const, label: 'Food & Dining', iconName: 'restaurant' },
 ].map(item => (
