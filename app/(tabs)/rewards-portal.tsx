          ...
          renderItem={({ item: reward }) => (
            <View style={[styles.rewardCard, !reward.available && { opacity: 0.5 }]}>
              ...
              <View style={styles.rewardRight}>
                ...
                <TouchableOpacity
                  style={[styles.redeemBtn, redeeming === reward.id && styles.redeemBtnSuccess, !reward.available && { backgroundColor: "rgba(255,255,255,0.55)" }]}
...
const styles = StyleSheet.create({
  ...
  balanceCard: { flex: 1, borderRadius: 18, overflow: "hidden", padding: 14, alignItems: "center", gap: 4, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  tierCard: { borderRadius: 18, overflow: "hidden", padding: 16, marginBottom: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", gap: 12 },
  ...
  tierProgress: { gap: 6 },
  tierProgressTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 4, overflow: "hidden" },
  ...
  tierRow: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  referCodeRow: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10, marginTop: 4 },
  ...
  rewardCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 16, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  rewardCategoryBadge: { backgroundColor: "rgba(255,255,255,0.55)", paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, alignSelf: "flex-start", marginTop: 2 },
  ...
  txRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
