...
const S = StyleSheet.create({
  ...
  consultTitle: { color: "#1A0B2E", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  consultDesc: { color: "rgba(255,255,255,0.6)", fontSize: 13, lineHeight: 20, marginTop: 6 },
  slotChip: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", alignItems: "center" },
  ...
  slotTime: { color: "#1A0B2E", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  bookBtn: { borderRadius: 12, shadowColor: "#F94498", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 24, elevation: 10,
    overflow: "hidden", paddingVertical: 12, alignItems: "center", marginTop: 12 },
  bookBtnText: { color: "#1A0B2E", fontSize: 14, fontWeight: "900", fontFamily: "Chillax-Bold" },
  filterRow: { paddingHorizontal: 20, gap: 8, paddingBottom: 130 },
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  filterLabelActive: { color: "#1A0B2E" },
  section: { paddingHorizontal: 20, gap: 12 },
  contactCard: { borderRadius: 18, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", padding: 16, gap: 12 },
  contactTop: { flexDirection: "row", gap: 14 },
  contactEmoji: { fontSize: 40, marginTop: 2 },
  contactInfo: { flex: 1, gap: 2 },
  contactName: { color: "#1A0B2E", fontSize: 16, fontWeight: "900", fontFamily: "Chillax-Bold" },
  contactRole: { color: "rgba(255,255,255,0.5)", fontSize: 13 },
  contactCompany: { color: "rgba(255,255,255,0.55)", fontSize: 12 },
  contactMeta: { flexDirection: "row", gap: 10, marginTop: 4 },
  contactRating: { color: "#F59E0B", fontSize: 12, fontWeight: "700" },
  contactDeals: { color: "rgba(255,255,255,0.5)", fontSize: 12 },
  ...
  contactLangsLabel: { color: "rgba(255,255,255,0.5)", fontSize: 12 },
  ...
  callBtnText: { color: "#1A0B2E", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
});
