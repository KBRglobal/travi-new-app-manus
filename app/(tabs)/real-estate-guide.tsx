...
const S = StyleSheet.create({
  ...
  introStat: { width: "45%" },
  introStatV: { color: "#6443F4", fontSize: 18, fontWeight: "900" },
  ...
  chapterTitle: { flex: 1, fontSize: 15, fontWeight: "900" },
  ...
  sectionItemArrow: { color: "rgba(255,255,255,0.4)", fontSize: 16, fontWeight: "700" },
  ...
  ctaTitle: { color: "#FFFFFF", fontSize: 20, fontWeight: "900" },
