...
export default function ShareTripModal() {
  ...
  const shareOptions = [
    { emoji: '📱', name: 'Share Link', desc: 'Copy trip link to clipboard' },
    { emoji: '📧', name: 'Email', desc: 'Send trip details via email' },
    { emoji: '💬', name: 'WhatsApp', desc: 'Share on WhatsApp' },
    { emoji: '📸', name: 'Instagram', desc: 'Share as Instagram story' },
    { emoji: '🐦', name: 'Twitter', desc: 'Tweet about your trip' },
    { emoji: '👥', name: 'TRAVI Friends', desc: 'Share with travel buddies' },
  ];
