                ...
                <View style={styles.timeSlotsGrid}>
                  {TIME_SLOTS.map((time) => (
                    <TouchableOpacity
                      ...
                      activeOpacity={0.8}
                    >
                      <Text style={[styles.timeSlotText, selectedTime === time && { color: "#1A0B2E" }]}>{time}</Text>
                    </TouchableOpacity>
                  ))}
                </View>
...
const styles = StyleSheet.create({
  ...
  heroRating: { color: "#1A0B2E", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  heroReviews: { color: "rgba(255,255,255,0.5)", fontSize: 12 },
  heroDot: { color: "rgba(255,255,255,0.55)", fontSize: 12 },
  ...
  tabs: { flexDirection: "row", marginHorizontal: 20, marginTop: 12, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, padding: 4 },
  ...
  highlightChip: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 10, padding: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  highlightText: { color: "rgba(255,255,255,0.75)", fontSize: 13 },
  menuCategory: { marginBottom: 20 },
  menuCategoryTitle: { color: "#1A0B2E", fontSize: 15, fontWeight: "800", marginBottom: 10, paddingBottom: 130, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)", fontFamily: "Chillax-Bold" },
  menuItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)" },
  menuItemEmoji: { fontSize: 24, marginTop: 2 },
  menuItemInfo: { flex: 1 },
  menuItemName: { color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
  menuItemDesc: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 2, lineHeight: 16 },
  menuItemPrice: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ratingOverview: { alignItems: "center", paddingVertical: 20, gap: 4 },
  ratingBig: { color: "#1A0B2E", fontSize: 48, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  reserveLabel: { color: "#1A0B2E", fontSize: 15, fontWeight: "800", marginBottom: 12, fontFamily: "Chillax-Bold" },
  partySizeScroll: { marginBottom: 4 },
  partySizeContent: { gap: 8, paddingRight: 20 },
  partySizeChip: { paddingHorizontal: 16, paddingVertical: 9, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  partySizeTextActive: { color: "#1A0B2E" },
  timeSlotsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginBottom: 24 },
  timeSlot: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.12)" },
  ...
  reserveBtnText: { color: "#1A0B2E", fontSize: 15, fontWeight: "800", fontFamily: "Chillax-Bold" },
  reservedCard: { alignItems: "center", paddingVertical: 40, gap: 10 },
  reservedEmoji: { fontSize: 56 },
  reservedTitle: { color: "#1A0B2E", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  reservedCashbackText: { color: "#22C55E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
});
