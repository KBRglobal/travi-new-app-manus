...
const styles = StyleSheet.create({
  ...
  xpPillText: { color: "#C084FC", fontSize: 12, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  xpTier: { color: "#1A0B2E", fontSize: 15, fontWeight: "800", fontFamily: "Chillax-Bold" },
  xpProgress: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 2 },
  xpPct: { color: "#C084FC", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  xpBarTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 4, overflow: "hidden" },
  xpBarFill: { height: 8, borderRadius: 4 },
  tabs: { flexDirection: "row", marginHorizontal: 20, marginBottom: 10, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, padding: 4 },
  ...
  categoryChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  categoryTextActive: { color: "#1A0B2E" },
  badgesGrid: { paddingHorizontal: 20, paddingBottom: 130, gap: 12 },
  badgeCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 16, padding: 14, alignItems: "center", gap: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", overflow: "hidden", marginHorizontal: 0 },
  ...
  rarityText: { fontSize: 9, fontWeight: "900", fontFamily: "Chillax-Bold" },
  badgeEmoji: { fontSize: 36, marginTop: 8 },
  badgeTitle: { color: "#1A0B2E", fontSize: 13, fontWeight: "800", textAlign: "center", fontFamily: "Chillax-Bold" },
  ...
  earnedText: { color: "#22C55E", fontSize: 11, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  progressText: { color: "rgba(255,255,255,0.5)", fontSize: 10, textAlign: "center" },
  lockedText: { color: "rgba(255,255,255,0.55)", fontSize: 11 },
  podium: { flexDirection: "row", alignItems: "flex-end", justifyContent: "center", gap: 8, paddingHorizontal: 20, paddingTop: 16, paddingBottom: 130 },
  ...
  podiumAvatarText: { color: "#1A0B2E", fontSize: 14, fontWeight: "900", fontFamily: "Chillax-Bold" },
  podiumName: { color: "#1A0B2E", fontSize: 11, fontWeight: "700", textAlign: "center" },
  podiumXP: { fontSize: 11, fontWeight: "900", marginBottom: 4, fontFamily: "Chillax-Bold" },
  podiumBase: { width: "100%", alignItems: "center", justifyContent: "center", borderTopWidth: 2, borderRadius: 4 },
  podiumRank: { fontSize: 18, fontWeight: "900", paddingTop: 8, fontFamily: "Chillax-Bold" },
  leaderboardList: { paddingHorizontal: 20, paddingBottom: 130 },
  leaderRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", overflow: "hidden" },
  leaderRowMe: { borderColor: "rgba(100,67,244,0.4)" },
  leaderRank: { color: "rgba(255,255,255,0.5)", fontSize: 14, fontWeight: "800", width: 28, fontFamily: "Chillax-Bold" },
  leaderAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.06)", alignItems: "center", justifyContent: "center" },
  leaderAvatarText: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  leaderInfo: { flex: 1 },
  leaderName: { color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
  leaderTrips: { color: "rgba(255,255,255,0.5)", fontSize: 12 },
  leaderXP: { color: "#C084FC", fontSize: 14, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  modalCard: { width: width - 60, borderRadius: 24, overflow: "hidden", padding: 24, alignItems: "center", gap: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  modalEmoji: { fontSize: 56 },
  modalTitle: { color: "#1A0B2E", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
  modalRarity: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 10 },
  modalRarityText: { fontSize: 12, fontWeight: "900", fontFamily: "Chillax-Bold" },
  modalDesc: { color: "rgba(255,255,255,0.6)", fontSize: 14, textAlign: "center", lineHeight: 22, fontFamily: "Satoshi-Regular" },
  modalXP: { fontSize: 20, fontWeight: "900", fontFamily: "Chillax-Bold" },
  modalEarned: { backgroundColor: "rgba(34,197,94,0.2)", paddingHorizontal: 14, paddingVertical: 6, borderRadius: 10 },
  modalEarnedText: { color: "#22C55E", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  modalProgress: { width: "100%", gap: 6 },
  modalProgressTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 4, overflow: "hidden" },
  modalProgressFill: { height: 8, borderRadius: 4 },
  modalProgressText: { color: "rgba(255,255,255,0.5)", fontSize: 12, textAlign: "center" },
  modalClose: { marginTop: 8, backgroundColor: "rgba(255,255,255,0.06)", paddingHorizontal: 24, paddingVertical: 10, borderRadius: 14 },
  modalCloseText: { color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
});
