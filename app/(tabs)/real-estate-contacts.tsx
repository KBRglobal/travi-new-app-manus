...
const S = StyleSheet.create({
  ...
  slotTime: { color: "#FFFFFF", fontSize: 13, fontWeight: "800" },
  bookBtn: { borderRadius: 12, overflow: "hidden", paddingVertical: 12, alignItems: "center", marginTop: 12 },
  bookBtnText: { color: "#FFFFFF", fontSize: 14, fontWeight: "900" },
  ...
  contactName: { color: "#FFFFFF", fontSize: 16, fontWeight: "900" },
