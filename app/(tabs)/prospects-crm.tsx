          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.stageFilterScroll} contentContainerStyle={styles.stageFilterContent}>
            {(["All", ...PIPELINE_STAGES] as const).map((stage) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={[styles.stageFilterText, selectedStage === stage && { color: "#FFFFFF" }]}>{stage}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
          <FlatList
...
const styles = StyleSheet.create({
  ...
  addBtnText: { color: "#FFFFFF", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  kpiRow: { flexDirection: "row", paddingHorizontal: 20, gap: 10, marginBottom: 12 },
  kpiCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 10, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  kpiValue: { fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  kpiLabel: { color: "rgba(255,255,255,0.5)", fontSize: 10, marginTop: 2 },
  tabs: { flexDirection: "row", marginHorizontal: 20, marginBottom: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 4 },
  ...
  stageName: { flex: 1, color: "#FFFFFF", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  prospectCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  prospectAvatarText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  prospectInfo: { flex: 1 },
  prospectName: { color: "#FFFFFF", fontSize: 14, fontWeight: "700" },
  ...
  prospectValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", marginHorizontal: 20, marginBottom: 10, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, gap: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  searchIcon: { fontSize: 16 },
  searchInput: { flex: 1, color: "#FFFFFF", fontSize: 14, fontFamily: "Satoshi-Regular" },
  stageFilterScroll: { marginBottom: 10 },
  stageFilterContent: { paddingHorizontal: 20, gap: 8 },
  stageFilter: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  stageFilterText: { color: "rgba(255,255,255,0.5)", fontSize: 12, fontWeight: "700" },
  contactsList: { paddingHorizontal: 20, paddingBottom: 130 },
  contactCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  contactAvatar: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center" },
  contactAvatarText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", fontFamily: "Chillax-Bold" },
  contactInfo: { flex: 1 },
  ...
  contactTag: { backgroundColor: "rgba(255,255,255,0.55)", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  contactTagText: { color: "rgba(255,255,255,0.5)", fontSize: 10 },
  contactRight: { alignItems: "flex-end", gap: 4 },
  contactValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", fontFamily: "Chillax-Bold" },
  analyticsTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 14, fontFamily: "Chillax-Bold" },
  ...
  analyticsBarWrap: { flex: 1, height: 8, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 4, overflow: "hidden" },
  analyticsBar: { height: 8, borderRadius: 4 },
  analyticsValue: { color: "#FFFFFF", fontSize: 13, fontWeight: "700", width: 50, textAlign: "right" },
  marketCard: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 12, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  marketCountry: { flex: 1, color: "#FFFFFF", fontSize: 14, fontWeight: "700" },
  ...
  // Detail styles
  detailProfileCard: { alignItems: "center", paddingVertical: 24, gap: 6, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 20, marginBottom: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  detailAvatar: { width: 72, height: 72, borderRadius: 36, alignItems: "center", justifyContent: "center", marginBottom: 4 },
  detailAvatarText: { color: "#FFFFFF", fontSize: 24, fontWeight: "900", fontFamily: "Chillax-Bold" },
  detailName: { color: "#FFFFFF", fontSize: 20, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  detailContactChip: { backgroundColor: "rgba(255,255,255,0.55)", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10 },
  ...
  dealValueAmount: { color: "#FFFFFF", fontSize: 32, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  stageBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.55)" },
  ...
  notesCard: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  actionBtnText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
});
