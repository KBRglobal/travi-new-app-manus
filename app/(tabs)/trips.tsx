...
const wS = StyleSheet.create({
  ...
  widgetCta: { backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 12, paddingVertical: 8, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.15)" },
...
const styles = StyleSheet.create({
  ...
  statLabel: { color: "rgba(255,255,255,0.65)", fontSize: 11, fontFamily: "Satoshi-Regular" },
  filterRow: { flexDirection: "row", borderRadius: 16, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.15)", backgroundColor: "rgba(255,255,255,0.06)" },
  filterTab: { flex: 1, paddingVertical: 13, alignItems: "center", overflow: "hidden" },
  filterTabActive: {},
  filterTabText: { color: "rgba(255,255,255,0.55)", fontSize: 14, fontWeight: "600", fontFamily: "Satoshi-Medium" },
  filterTabTextActive: { color: "#FFFFFF" },
  tripCard: { borderRadius: 20, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.15)" },
  ...
  tripEmojiWrap: { width: 52, height: 52, borderRadius: 16, backgroundColor: "rgba(255,255,255,0.1)", alignItems: "center", justifyContent: "center" },
