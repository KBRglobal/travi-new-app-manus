...
const S = StyleSheet.create({
  ...
  statChip: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4 },
  statIcon: { fontSize: 12 },
  statLabel: { color: "rgba(255,255,255,0.75)", fontSize: 11, fontWeight: "600" },

  tabsContainer: { backgroundColor: "rgba(13,6,40,0.95)", borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.12)" },
