...
const S = StyleSheet.create({
  ...
  header: { paddingHorizontal: 20, paddingTop: 16, paddingBottom: 130 },
  ...
  chipText: { color: "rgba(255,255,255,0.65)", fontSize: 13, fontWeight: "600", fontFamily: "Chillax-Semibold" },
