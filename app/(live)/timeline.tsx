...
const TIMELINE = [
 { time: '8:00 AM', iconName: 'sunny', title: 'Wake up', desc: 'Hotel Shinjuku', status: 'done' },
 { time: '9:00 AM', emoji: '', title: 'Breakfast', desc: 'Hotel restaurant', status: 'done' },
 { time: '10:00 AM', iconName: 'business', title: 'Meiji Shrine', desc: 'Guided tour • 1.5 hrs', status: 'done' },
 { time: '12:00 PM', iconName: 'restaurant', title: 'Lunch at Ichiran', desc: 'Ramen • Harajuku', status: 'current' },
 { time: '2:00 PM', iconName: 'bag', title: 'Shopping', desc: 'Takeshita Street', status: 'upcoming' },
 { time: '4:00 PM', emoji: 'business', title: 'Shibuya Crossing', desc: 'Photo opportunity', status: 'upcoming' },
 { time: '6:00 PM', emoji: 'restaurant', title: 'Dinner', desc: 'Sushi Nakazawa • Reserved', status: 'upcoming' },
...
export default function TimelineScreen() {
 ...
 {item.status === 'done' && <Ionicons name="checkmark" size={24} color="#FFFFFF" />}
