...
const T = StyleSheet.create({
  wrap: { gap: 12 },
  sectionTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", marginTop: 4, marginBottom: 4 },
  ...
  regionName: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  ...
  regionDesc: { color: "rgba(255,255,255,0.55)", fontSize: 13, lineHeight: 19 },
  ...
  cultureName: { color: "#FFFFFF", fontSize: 14, fontWeight: "700", marginBottom: 3 },
  cultureDesc: { color: "rgba(255,255,255,0.55)", fontSize: 13, lineHeight: 18 },
  ...
  foodName: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  foodPrice: { color: "#FFD700", fontSize: 14, fontWeight: "800" },
  ...
  foodDesc: { color: "rgba(255,255,255,0.55)", fontSize: 13, lineHeight: 18 },
  ...
  budgetLabel: { fontSize: 15, fontWeight: "800", flex: 1 },
  budgetDaily: { fontSize: 14, fontWeight: "700" },
  budgetRow: { flexDirection: "row", justifyContent: "space-between" },
  budgetRowLabel: { color: "rgba(255,255,255,0.45)", fontSize: 13 },
  budgetRowValue: { color: "rgba(255,255,255,0.75)", fontSize: 13, fontWeight: "600" },
...
const S = StyleSheet.create({
  ...
  heroName: { color: "#FFFFFF", fontSize: 34, fontWeight: "900", lineHeight: 38 },
  heroCountry: { color: "rgba(255,255,255,0.55)", fontSize: 14, fontWeight: "600" },
  heroTagline: { color: "rgba(255,255,255,0.45)", fontSize: 13, fontStyle: "italic", marginBottom: 8 },
