...
const styles = StyleSheet.create({
  ...
  triggeredText: { fontSize: 11, fontWeight: "800", color: "#fff", fontFamily: "Chillax-Bold" },
  watchingBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  priceValueSavings: { fontSize: 22, fontWeight: "800", color: "#34D399", fontFamily: "Chillax-Bold" },
  ...
  bookNowText: { fontSize: 15, fontWeight: "700", color: "#fff", fontFamily: "Chillax-Semibold" },
  ...
  emptyBtnText: { fontSize: 15, fontWeight: "700", color: "#fff", fontFamily: "Chillax-Semibold" },
  howItWorks: { marginHorizontal: 20, marginTop: 8 },
  howTitle: { fontSize: 16, fontWeight: "700", color: "#F9FAFB", marginBottom: 16, fontFamily: "Chillax-Semibold" },
  ...
  destCity: { fontSize: 15, fontWeight: "700", color: "#F9FAFB", fontFamily: "Chillax-Semibold" },
  destPrice: { fontSize: 13, color: "#A78BFA", fontWeight: "600", fontFamily: "Satoshi-Medium" },
  ...
  priceInputLabel: { fontSize: 15, color: "#E5E7EB", fontWeight: "600", marginBottom: 12, fontFamily: "Satoshi-Medium" },
  priceInputWrap: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#1E0A3C",
  ...
  dollarSign: { fontSize: 24, fontWeight: "800", color: "#A78BFA", marginRight: 8, fontFamily: "Chillax-Bold" },
  priceInput: { flex: 1, fontSize: 32, fontWeight: "800", color: "#F9FAFB", paddingVertical: 12, fontFamily: "Chillax-Bold" },
  alertNowBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  alertNowText: { flex: 1, fontSize: 13, color: "#34D399", lineHeight: 18, fontFamily: "Satoshi-Regular" },
  ...
  createBtnText: { fontSize: 16, fontWeight: "700", color: "#fff", fontFamily: "Chillax-Semibold" },
});
