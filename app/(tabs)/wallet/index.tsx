...
const TRANSACTIONS = [
 { name: 'Hotel Luxe', amount: -445, date: 'Apr 12', iconName: 'bed' },
 { name: 'Points Cashback', amount: 25, date: 'Apr 11', iconName: 'star' },
 { name: 'Restaurant', amount: -32, date: 'Apr 11', iconName: 'restaurant' },
];
...
export default function WalletScreen() {
 ...
 <Text className="text-xl mb-1">swap-horizontal</Text>
