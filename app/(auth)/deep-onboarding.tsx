...
const styles = StyleSheet.create({
  ...
  sliderLabelText: { color: "rgba(255,255,255,0.4)", fontSize: 13, fontFamily: "Satoshi-Regular" },
  sliderHint: { color: "rgba(255,255,255,0.35)", fontSize: 13, textAlign: "center", lineHeight: 20, paddingHorizontal: 20, fontFamily: "Satoshi-Regular" },
