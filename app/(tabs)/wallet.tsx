...
const TIERS = [
  ...
  { name: "Elite Nomad",  min: 30000, max: Infinity, color: "#FBBF24", emoji: "👑" },
];
...
const tm = StyleSheet.create({
  ...
  helpText: { color: "rgba(255,255,255,0.5)", fontSize: 14 },
});
        ...
        {activeTab === "redeem" && (
          <View style={S.tabContent}>
            ...
            <FlatList
              ...
              contentContainerStyle={{ paddingLeft: 20, paddingRight: 8, paddingTop: 12, paddingBottom: 130 }}
...
const S = StyleSheet.create({
  ...
  tierRange: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 1 },
  ...
  redeemDesc: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 1 },
  ...
  txSub: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 1 },
