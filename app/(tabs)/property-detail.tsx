...
const S = StyleSheet.create({
  ...
  badgeText: { color: "#1A0B2E", fontSize: 11, fontWeight: "800", fontFamily: "Chillax-Bold" },
  priceRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 20, paddingVertical: 16 },
  price: { color: "#1A0B2E", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
  pricePerSqft: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 2 },
  statsRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  stat: { alignItems: "center", gap: 2 },
  statVal: { color: "#1A0B2E", fontSize: 16, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  highlightValue: { color: "#1A0B2E", fontSize: 13, fontWeight: "700" },
  ...
  roiInput: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", paddingHorizontal: 12, paddingVertical: 10, color: "#1A0B2E", fontSize: 14, fontWeight: "700" },
  ...
  roiYearTextActive: { color: "#1A0B2E" },
  roiResults: { flexDirection: "row", alignItems: "center" },
  roiResult: { flex: 1, alignItems: "center", gap: 4 },
  roiResultVal: { color: "#1A0B2E", fontSize: 15, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  similarTitle: { color: "#1A0B2E", fontSize: 12, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  ctaSecondaryText: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  ctaPrimaryText: { color: "#1A0B2E", fontSize: 14, fontWeight: "900", fontFamily: "Chillax-Bold" },
});
