...
const S = StyleSheet.create({
  ...
  handle: { width: 40, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.06)", alignSelf: "center", marginTop: 12, marginBottom: 8 },
  progressTrack: { height: 3, marginHorizontal: 20, marginBottom: 4, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 2, overflow: "hidden" },
  ...
  // Payment step
  paymentCard: { borderRadius: 16, overflow: "hidden", padding: 16, flexDirection: "row", alignItems: "center", gap: 14, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.12)", backgroundColor: "rgba(255,255,255,0.06)" },
  ...
  confirmDetails: { width: "100%", backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 16, padding: 16, gap: 12 },
