...
const ALL_ATTRACTIONS: Attraction[] = [
  ...
  { id: "d8", name: "Dubai Marina Night Walk", type: "Nightlife", category: "nightlife", destination: "dubai",
    ...
    description: "Yacht-lined waterfront with dozens of restaurants, bars, and a buzzing atmosphere.", color: "#6443F4" },
  ...
  { id: "k5", name: "Geisha District Night Walk", type: "Cultural Experience", category: "art_culture", destination: "kyoto",
    ...
    description: "Cobblestone streets lined with ochaya teahouses. Spot a geiko if you're lucky.", color: "#F94498" },
  ...
  { id: "p3", name: "Montmartre & Sacré-Cœur", type: "Neighborhood", category: "history", destination: "paris",
    ...
    description: "Cobblestone streets, street artists, and the white dome of Sacré-Cœur overlooking Paris.", color: "#6443F4" },
  ...
  { id: "p8", name: "Moulin Rouge Show", type: "Nightlife", category: "nightlife", destination: "paris",
    ...
    description: "The world's most famous cabaret. Feathers, sequins, and the original cancan since 1889.", color: "#F94498" },
  ...
  { id: "t3", name: "Shinjuku Nightlife", type: "Nightlife", category: "nightlife", destination: "tokyo",
    ...
    description: "200 bars in one block. Golden Gai, Robot Restaurant, and izakayas that never close.", color: "#6443F4" },
  { id: "t4", name: "teamLab Planets", type: "Art Experience", category: "art_culture", destination: "tokyo",
    ...
    description: "Walk through rooms of infinite mirrors, floating flowers, and digital waterfalls. Mind-bending.", color: "#F94498" },
  ...
  { id: "t6", name: "Harajuku Takeshita Street", type: "Shopping", category: "shopping", destination: "tokyo",
    ...
    description: "Japan's fashion epicenter. Cosplay, kawaii crepes, and street style that defies reality.", color: "#F94498" },
  ...
  { id: "t8", name: "Akihabara Electronics & Anime", type: "Shopping", category: "shopping", destination: "tokyo",
    ...
    description: "7 floors of electronics, anime figurines, and retro games. Nerd paradise in neon.", color: "#6443F4" },
  // ─── Rome ───────────────────────────────────────────────────────────────────
  ...
  { id: "r2", name: "Vatican Museums & Sistine Chapel", type: "Museum", category: "art_culture", destination: "rome",
    ...
    description: "Michelangelo's ceiling will stop you in your tracks. The greatest art collection on Earth.", color: "#6443F4" },
  ...
  { id: "r6", name: "Aperitivo at Campo de Fiori", type: "Nightlife", category: "nightlife", destination: "rome",
    ...
    description: "Romans gather here every evening. Wine, bruschetta, and the best people-watching in Italy.", color: "#F94498" },
  // ─── London ─────────────────────────────────────────────────────────────────
  ...
  { id: "l3", name: "Tate Modern & South Bank", type: "Museum", category: "art_culture", destination: "london",
    ...
    description: "World-class modern art in a converted power station. Free entry, priceless views of the Thames.", color: "#6443F4" },
  { id: "l4", name: "Notting Hill & Portobello Market", type: "Shopping", category: "shopping", destination: "london",
    ...
    description: "Pastel houses, vintage records, and antique treasures. London's most photogenic neighborhood.", color: "#F94498" },
  ...
  { id: "am1", name: "Rijksmuseum & Vermeer", type: "Museum", category: "art_culture", destination: "amsterdam",
    ...
    description: "Rembrandt's Night Watch in real life. The greatest Dutch art collection in the world.", color: "#6443F4" },
  ...
  { id: "sg4", name: "Chinatown & Little India", type: "Cultural Walk", category: "art_culture", destination: "singapore",
    ...
    description: "Four cultures in one city. Temples, mosques, churches, and the best laksa you'll ever eat.", color: "#F94498" },
  // ─── Marrakech ──────────────────────────────────────────────────────────────
  ...
  { id: "ct3", name: "V&A Waterfront & Wine Tasting", type: "Food & Drink", category: "food", destination: "cape town",
    ...
    description: "World-class Cape wines, fresh crayfish, and Table Mountain as your backdrop.", color: "#6443F4" },
  // ─── Wellness (global) ─────────────────────────────────────────────────────────
  ...
  { id: "adv2", name: "Northern Lights Snowmobile", type: "Adventure", category: "adventure", destination: "reykjavik",
    ...
    description: "Race across a glacier at midnight under dancing green and purple auroras.", color: "#6443F4" },
  ...
  { id: "lux3", name: "Michelin Star Dinner Paris", type: "Luxury Dining", category: "wellness", destination: "paris",
    ...
    description: "A 3-Michelin-star experience. 12 courses, 6 wine pairings, and a memory that lasts forever.", color: "#F94498" },
  // ─── Family (global) ─────────────────────────────────────────────────────────
  { id: "fam1", name: "Disneyland Tokyo", type: "Theme Park", category: "landmarks", destination: "tokyo",
    ...
    description: "The cleanest, most magical Disney park in the world. Unique rides and Japanese hospitality.", color: "#F94498" },
  ...
  { id: "ist1", name: "Hagia Sophia & Blue Mosque", type: "Historical Site", category: "history", destination: "istanbul",
    ...
    description: "1,500 years of history in one building. The greatest architectural achievement of the ancient world.", color: "#6443F4" },
  ...
  { id: "ny6", name: "Jazz Club in Harlem", type: "Nightlife", category: "nightlife", destination: "new york",
    ...
    description: "Where jazz was born. Live music, cocktails, and a crowd that knows how to listen.", color: "#6443F4" },
...
const styles = StyleSheet.create<any>({
  ...
  // Category badge
  categoryBadge: { position: "absolute", top: 20, left: 20, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, backgroundColor: "rgba(0,0,0,0.4)" },
