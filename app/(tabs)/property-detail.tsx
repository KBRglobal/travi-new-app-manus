...
const S = StyleSheet.create({
  ...
  headerTitle: { flex: 1, color: "#FFFFFF", fontSize: 16, fontWeight: "900" },
  ...
  addressText: { color: "rgba(255,255,255,0.5)", fontSize: 13 },
  ...
  roiYearText: { color: "rgba(255,255,255,0.4)", fontSize: 12, fontWeight: "800" },
  roiYearTextActive: { color: "#FFFFFF" },
  roiResults: { flexDirection: "row", alignItems: "center" },
  roiResult: { flex: 1, alignItems: "center", gap: 4 },
  roiResultVal: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
  ...
  similarTitle: { color: "#FFFFFF", fontSize: 12, fontWeight: "800" },
  ...
  ctaPrimaryText: { color: "#FFFFFF", fontSize: 14, fontWeight: "900" },
});
