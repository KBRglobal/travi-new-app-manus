...
const styles = StyleSheet.create({
  ...
  itemCard: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  // Explainer
  explainerCard: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", flexDirection: "row", alignItems: "flex-start" },
  ...
  summaryHighlight: { marginTop: 8, paddingTop: 12, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.55)" },
  ...
  inviteBtn: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, paddingVertical: 14, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  modal: { width: width - 60, borderRadius: 24, padding: 32, alignItems: "center", overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
