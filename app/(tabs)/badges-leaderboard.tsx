...
const styles = StyleSheet.create({
  ...
  xpBarTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 4, overflow: "hidden" },
  xpBarFill: { height: 8, borderRadius: 4 },
  tabs: { flexDirection: "row", marginHorizontal: 20, marginBottom: 10, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 4 },
  ...
  categoryChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  badgeCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 16, padding: 14, alignItems: "center", gap: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", overflow: "hidden", marginHorizontal: 0 },
  ...
  leaderRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", overflow: "hidden" },
  ...
  leaderAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.55)", alignItems: "center", justifyContent: "center" },
  ...
  modalCard: { width: width - 60, borderRadius: 24, overflow: "hidden", padding: 24, alignItems: "center", gap: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  modalProgressTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 4, overflow: "hidden" },
  modalProgressFill: { height: 8, borderRadius: 4 },
  modalProgressText: { color: "rgba(255,255,255,0.5)", fontSize: 12, textAlign: "center" },
  modalClose: { marginTop: 8, backgroundColor: "rgba(255,255,255,0.55)", paddingHorizontal: 24, paddingVertical: 10, borderRadius: 14 },
