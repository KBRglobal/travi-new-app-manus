...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: "row", marginHorizontal: 20, marginTop: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 4 },
  ...
  highlightChip: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 10, padding: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  highlightText: { color: "rgba(255,255,255,0.75)", fontSize: 13 },
  menuCategory: { marginBottom: 20 },
  menuCategoryTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 10, paddingBottom: 130, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.55)", fontFamily: "Chillax-Bold" },
  menuItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.55)" },
  ...
  partySizeChip: { paddingHorizontal: 16, paddingVertical: 9, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  timeSlot: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.55)" },
