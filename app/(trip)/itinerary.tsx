...
const styles = StyleSheet.create({
  ...
  shareBtn: { width: 36, height: 36, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.55)", alignItems: "center", justifyContent: "center" },
  // Day pill selector — compact horizontal
  dayRow: { flexDirection: "row", paddingHorizontal: 20, gap: 8, marginBottom: 10 },
  dayPill: { flex: 1, borderRadius: 12, paddingVertical: 8, backgroundColor: "rgba(255,255,255,0.55)", borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", overflow: "hidden", alignItems: "center", gap: 1 },
  ...
  stopCountBadge: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  stopLine: { flex: 1, width: 2, backgroundColor: "rgba(255,255,255,0.55)", marginTop: 4 },
  ...
  stopNote: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 8, padding: 8, marginTop: 2 },
  ...
  transferVertLine: { width: 2, height: 28, backgroundColor: "rgba(255,255,255,0.55)" },
  ...
  // Bottom bar
  bottomBar: { paddingHorizontal: 20, paddingTop: 12, backgroundColor: "rgba(13,6,40,0.98)", gap: 8, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.55)" },
