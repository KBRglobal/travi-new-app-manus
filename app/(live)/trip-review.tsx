...
const S = StyleSheet.create({
  ...
  noteInput: { backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 12, padding: 12, color: "#FFF", fontSize: 14, fontFamily: "Satoshi-Regular", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", minHeight: 60, textAlignVertical: "top" },
