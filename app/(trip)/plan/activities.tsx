...
export default function PlanActivitiesScreen() {
 ...
 <View className="w-12 h-12 bg-white/5 rounded-button items-center justify-center mr-3"><Ionicons name="flag" size={24} color="#FFFFFF" /></View>
 ...
 {selected.includes(item.id) && <View className="w-6 h-6 bg-primary rounded-full items-center justify-center"><Ionicons name="checkmark" size={24} color="#FFFFFF" /></View>}
 </Pressable>
 )}
 />
