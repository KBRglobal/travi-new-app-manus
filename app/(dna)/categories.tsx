 ...
 * 10 scenario-based DNA questions → DNA result screen
 */
...
import type { TripPace } from "@/lib/store";
...
const QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "8d", label: "The feeling of total peace", sublabel: "No phone, no stress, just present", colors: ["#0E7490", "#06B6D4"], iconName: "moon.stars.fill", tags: ["relax", "solo", "nature"] },
    ],
  },
  {
    id: 9,
...
const DNA_PROFILES: Record<string, { title: string; iconName: any; description: string; destinations: { name: string; image: number }[]; colors: [string, string] }> = {
...
export default function QuizScreen() {
  ...
  const handleFinish = async () => {
    dispatch({
      type: "UPDATE_PROFILE",
      payload: {
        travelerDNA: { type: dnaProfile.title },
...
const S = StyleSheet.create({
  ...
  questionNumBadge: { borderRadius: 10, overflow: "hidden", paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: "rgba(100,67,244,0.4)" },
