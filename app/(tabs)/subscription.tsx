...
const S = StyleSheet.create({
  ...
  planName: { fontSize: 14, fontWeight: "700", letterSpacing: 0.5, textTransform: "uppercase", fontFamily: "Chillax-Semibold" },
  planPriceRow: { flexDirection: "row", alignItems: "baseline", gap: 4 },
  planPrice: { fontSize: 36, fontWeight: "900", letterSpacing: -1, fontFamily: "Chillax-Bold" },
  planPeriod: { color: "rgba(255,255,255,0.5)", fontSize: 14, fontFamily: "Satoshi-Regular" },
  planTagline: { color: "rgba(255,255,255,0.5)", fontSize: 13, fontFamily: "Satoshi-Regular" },
