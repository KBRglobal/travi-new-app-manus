...
const styles = StyleSheet.create({
  ...
  badgeText: { color: "#FFFFFF", fontSize: 18, fontWeight: "900", letterSpacing: 2 },
  ...
  cardLabel: { color: "#FFFFFF", fontSize: 22, fontWeight: "800", textAlign: "center", textShadowColor: "rgba(0,0,0,0.5)", textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8 },
  ...
  resultSub: { color: "rgba(255,255,255,0.5)", fontSize: 14, marginTop: 6, textAlign: "center" },
  ...
  topTypeName: { color: "#FFFFFF", fontSize: 32, fontWeight: "900" },
  topTypeScore: { color: "#6443F4", fontSize: 16, fontWeight: "700", marginTop: 4 },
  dimsTitle: { color: "rgba(255,255,255,0.6)", fontSize: 13, fontWeight: "700", letterSpacing: 1, marginBottom: 16 },
  ...
  dimLabel: { color: "rgba(255,255,255,0.8)", fontSize: 13, fontWeight: "600" },
  ...
  dimScore: { color: "rgba(255,255,255,0.6)", fontSize: 12, fontWeight: "700", width: 28, textAlign: "right" },
  ...
  xpTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
  ...
  secondaryCtaText: { color: "rgba(255,255,255,0.5)", fontSize: 13, textDecorationLine: "underline" },
});
