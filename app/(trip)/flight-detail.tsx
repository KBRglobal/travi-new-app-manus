...
const styles = StyleSheet.create({
  ...
  airlineName: { color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  ...
  routeCode: { color: "#FFFFFF", fontSize: 28, fontWeight: "900" },
  routeCity: { color: "rgba(255,255,255,0.6)", fontSize: 12 },
  routeTime: { color: "#FFFFFF", fontSize: 16, fontWeight: "700", marginTop: 4 },
  ...
  routeLineBar: { flex: 1, height: 1, backgroundColor: "rgba(255,255,255,0.3)" },
  ...
  cashbackInfo: { flex: 1 },
  cashbackTitle: { color: "#22C55E", fontSize: 15, fontWeight: "800" },
  ...
  classCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, padding: 12, alignItems: "center", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.08)" },
  className: { color: "rgba(255,255,255,0.7)", fontSize: 12, fontWeight: "700" },
  classPrice: { fontSize: 16, fontWeight: "900", marginTop: 4 },
  perksCard: { backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, padding: 14, gap: 8, marginBottom: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  amenityChip: { backgroundColor: "rgba(255,255,255,0.07)", borderRadius: 20, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  amenityText: { color: "rgba(255,255,255,0.75)", fontSize: 13 },
  baggageCard: { backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, overflow: "hidden", marginBottom: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  baggageRow: { flexDirection: "row", alignItems: "center", gap: 12, padding: 14 },
  baggageRowBorder: { borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.06)" },
  ...
  bookingBar: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "rgba(13,6,40,0.95)", paddingHorizontal: 20, paddingTop: 14, flexDirection: "row", alignItems: "center", gap: 14, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.08)" },
  bookingPrice: { flex: 1 },
  bookingPriceLabel: { color: "rgba(255,255,255,0.5)", fontSize: 11 },
  bookingPriceAmount: { color: "#FFFFFF", fontSize: 24, fontWeight: "900" },
  bookingCashback: { color: "#22C55E", fontSize: 12, fontWeight: "700" },
  bookBtn: { flex: 1.5, borderRadius: 16, overflow: "hidden" },
  bookBtnDone: {},
