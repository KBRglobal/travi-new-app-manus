...
const styles = StyleSheet.create({
  ...
  heroRating: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  highlightChip: { backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 10, padding: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  roomCard: { backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.08)", position: "relative" },
  roomHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 },
  roomTitleWrap: { flex: 1 },
  roomName: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  roomSize: { color: "rgba(255,255,255,0.5)", fontSize: 12, marginTop: 2 },
  roomPriceWrap: { alignItems: "flex-end" },
  roomPrice: { fontSize: 20, fontWeight: "900" },
  roomPriceNight: { color: "rgba(255,255,255,0.4)", fontSize: 11 },
