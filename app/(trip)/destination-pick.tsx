...
const styles = StyleSheet.create({
  ...
  cardName: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", marginBottom: 4 },
  vibePill: { alignSelf: "flex-start", backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 20, paddingHorizontal: 8, paddingVertical: 3 },
  vibeText: { color: "rgba(255,255,255,0.85)", fontSize: 11, fontWeight: "600" },
