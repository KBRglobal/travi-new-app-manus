...
const S = StyleSheet.create({
  ...
  daySummaryTheme: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 6 },
  ...
  stopPrice: { color: "#FFFFFF", fontSize: 16, fontWeight: "900" },
  ...
  totalValue: { color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  ...
  confirmTripBtnText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
});
