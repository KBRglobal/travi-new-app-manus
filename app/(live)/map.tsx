...
const styles = StyleSheet.create({
  ...
  headerInfo: { flex: 1 },
  headerTitle: { color: "#FFFFFF", fontSize: 18, fontFamily: "Chillax-Semibold", fontWeight: "700" },
  headerSubRow: { flexDirection: "row", alignItems: "center", marginTop: 1 },
  headerSub: { color: "#A78BCA", fontSize: 13, fontFamily: "Satoshi-Regular" },
  searchBtn: { padding: 8 },
  ...
  markerLabelText: { color: "#FFFFFF", fontSize: 10, fontFamily: "Chillax-Semibold", fontWeight: "700" },
  mapLabel: {
  ...
  mapLabelText: { color: "#FFFFFF", fontSize: 12, fontFamily: "Chillax-Semibold", fontWeight: "600" },
  mapControls: {
  ...
  mapControlText: { color: "#FFFFFF", fontSize: 18, fontFamily: "Satoshi-Regular", fontWeight: "300" },
  ...
  categoryLabel: { color: "#A78BCA", fontSize: 13, fontFamily: "Chillax-Semibold", fontWeight: "600" },
  ...
  placeName: { color: "#FFFFFF", fontSize: 15, fontFamily: "Chillax-Semibold", fontWeight: "700", flex: 1 },
  openBadge: {
    backgroundColor: "rgba(76,175,80,0.2)", borderRadius: 6,
    paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: "#4CAF50",
  },
  openText: { color: "#4CAF50", fontSize: 10, fontFamily: "Chillax-Semibold", fontWeight: "700" },
  closedBadge: {
    backgroundColor: "rgba(244,67,54,0.15)", borderRadius: 6,
    paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: "#F44336",
  },
  closedText: { color: "#F44336", fontSize: 10, fontFamily: "Chillax-Semibold", fontWeight: "700" },
  placeType: { color: "#A78BCA", fontSize: 12, fontFamily: "Satoshi-Regular", marginBottom: 6 },
  ...
  placeDetailText: { color: "#A78BCA", fontSize: 13, fontFamily: "Satoshi-Regular", flex: 1, lineHeight: 18 },
  ...
  placeTagText: { color: "#A78BCA", fontSize: 11, fontFamily: "Satoshi-Regular" },
  ...
  placeActionText: { color: "#FFFFFF", fontSize: 13, fontFamily: "Chillax-Semibold", fontWeight: "600" },
  placeActionBtnOutline: {
    flexDirection: "row", alignItems: "center",
    borderWidth: 1, borderColor: "#4A3080",
    borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7, gap: 5,
  },
  placeActionTextOutline: { color: "#A78BCA", fontSize: 13, fontFamily: "Satoshi-Regular" },
});
