...
const styles = StyleSheet.create({
  ...
  xpTier: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  badgeTitle: { color: "#FFFFFF", fontSize: 13, fontWeight: "800", textAlign: "center", fontFamily: "Chillax-Bold" },
  ...
  podiumAvatarText: { color: "#FFFFFF", fontSize: 14, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  leaderAvatarText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  leaderInfo: { flex: 1 },
  ...
  modalTitle: { color: "#FFFFFF", fontSize: 22, fontWeight: "900", fontFamily: "Chillax-Bold" },
