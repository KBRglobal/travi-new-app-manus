...
const styles = StyleSheet.create({
  ...
  kpiCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, padding: 10, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  prospectCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  prospectLastContact: { color: "rgba(255,255,255,0.35)", fontSize: 11, marginTop: 2 },
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", marginHorizontal: 20, marginBottom: 10, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, gap: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  stageFilter: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.05)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  stageFilterText: { color: "rgba(255,255,255,0.5)", fontSize: 12, fontWeight: "700" },
  contactsList: { paddingHorizontal: 20, paddingBottom: 40 },
  contactCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  marketCard: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 12, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  // Detail styles
  detailProfileCard: { alignItems: "center", paddingVertical: 24, gap: 6, backgroundColor: "rgba(255,255,255,0.03)", borderRadius: 20, marginBottom: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  detailCountry: { color: "rgba(255,255,255,0.4)", fontSize: 13, fontFamily: "Satoshi-Regular" },
  ...
  dealValueSub: { color: "rgba(255,255,255,0.4)", fontSize: 12, marginTop: 4 },
  sectionTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 10, fontFamily: "Chillax-Bold" },
  stageBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.05)", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.08)" },
  ...
  notesCard: { backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
