...
const styles = StyleSheet.create({
  ...
  dayPillDate: { color: "rgba(255,255,255,0.3)", fontSize: 10, fontFamily: "Satoshi-Regular" },
  ...
  themeInfo: { flex: 1 },
  themeDate: { color: "rgba(255,255,255,0.4)", fontSize: 11, fontFamily: "Chillax-Semibold", fontWeight: "600" },
  ...
  bookNote: { color: "rgba(255,255,255,0.35)", fontSize: 12, fontFamily: "Satoshi-Regular", textAlign: "center" },
});
