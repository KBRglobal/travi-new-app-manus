...
const TOAST_COLORS: Record<ToastType, { bg: string; border: string; emoji: string }> = {
 success: { bg: colors.successLight, border: colors.success, iconName: 'checkmark-circle' },
 error: { bg: colors.errorLight, border: colors.error, iconName: 'close-circle' },
 warning: { bg: colors.warningLight, border: colors.warning, iconName: 'warning' },
 info: { bg: colors.primaryLight, border: colors.primary, iconName: 'information-circle' },
};
