...
type DestinationEntry = { name: string; image: string };
const DNA_PROFILES: Record<string, { title: string; iconName: DNAIconName; description: string; destinations: DestinationEntry[]; colors: [string, string] }> = {
  culture: { title: "Cultural Explorer", iconName: "building.columns.fill", description: "You travel to understand the world. Museums, history, and authentic local experiences fuel your soul.", destinations: [{ name: "Kyoto, Japan", image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=400&q=80" }, { name: "Florence, Italy", image: "https://images.unsplash.com/photo-1541370976299-4d24be63e18f?w=400&q=80" }, { name: "Marrakech, Morocco", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=400&q=80" }], colors: ["#1E3A5F", "#2563EB"] },
  food: { title: "Culinary Nomad", iconName: "fork.knife", description: "Your itinerary is built around meals. You know the best street food spots before you land.", destinations: [{ name: "Tokyo, Japan", image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&q=80" }, { name: "Naples, Italy", image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&q=80" }, { name: "Bangkok, Thailand", image: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=400&q=80" }], colors: ["#7C2D12", "#DC2626"] },
  adventure: { title: "Adrenaline Seeker", iconName: "mountain.2.fill", description: "You need the rush. Hikes, dives, and off-the-beaten-path discoveries define your trips.", destinations: [{ name: "Queenstown, NZ", image: "https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=400&q=80" }, { name: "Patagonia, Chile", image: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=400&q=80" }, { name: "Nepal", image: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=400&q=80" }], colors: ["#065F46", "#10B981"] },
  luxury: { title: "Luxury Connoisseur", iconName: "crown.fill", description: "You believe travel should be an experience of the finest things. Quality over quantity, always.", destinations: [{ name: "Maldives", image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=400&q=80" }, { name: "Amalfi Coast, Italy", image: "https://images.unsplash.com/photo-1533587851505-d119e13fa0d7?w=400&q=80" }, { name: "Dubai, UAE", image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=400&q=80" }], colors: ["#292524", "#78716C"] },
  social: { title: "Social Butterfly", iconName: "person.2.fill", description: "You travel for the people — locals, fellow travelers, and the connections that last a lifetime.", destinations: [{ name: "Barcelona, Spain", image: "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=400&q=80" }, { name: "Bali, Indonesia", image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&q=80" }, { name: "Rio de Janeiro, Brazil", image: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=400&q=80" }], colors: ["#6B21A8", "#EC4899"] },
  nature: { title: "Nature Wanderer", iconName: "leaf.fill", description: "The best views have no WiFi. You seek wild places that remind you how small we are.", destinations: [{ name: "Iceland", image: "https://images.unsplash.com/photo-1476610182048-b716b8518aae?w=400&q=80" }, { name: "Costa Rica", image: "https://images.unsplash.com/photo-1518259102261-b40117eabbc9?w=400&q=80" }, { name: "Norwegian Fjords", image: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=400&q=80" }], colors: ["#14532D", "#22C55E"] },
  relax: { title: "Mindful Traveler", iconName: "moon.fill", description: "You travel to restore. Slow mornings, beautiful surroundings, and zero rush define your perfect trip.", destinations: [{ name: "Santorini, Greece", image: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=400&q=80" }, { name: "Ubud, Bali", image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&q=80" }, { name: "Tuscany, Italy", image: "https://images.unsplash.com/photo-1523531294919-4bcd7c65e216?w=400&q=80" }], colors: ["#0E7490", "#06B6D4"] },
  urban: { title: "City Connoisseur", iconName: "building.fill", description: "Skylines, rooftops, and the electric energy of great cities are your natural habitat.", destinations: [{ name: "New York, USA", image: "https://images.unsplash.com/photo-1485871981521-5b1fd3805eee?w=400&q=80" }, { name: "Tokyo, Japan", image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&q=80" }, { name: "London, UK", image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=400&q=80" }], colors: ["#0F172A", "#334155"] },
  spontaneous: { title: "Free Spirit", iconName: "bolt.fill", description: "Rules are for other travelers. You live for the unplanned moments that become the best stories.", destinations: [{ name: "Lisbon, Portugal", image: "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=400&q=80" }, { name: "Chiang Mai, Thailand", image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&q=80" }, { name: "Cape Town, South Africa", image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=400&q=80" }], colors: ["#B45309", "#F59E0B"] },
  planned: { title: "Master Planner", iconName: "list.bullet.clipboard.fill", description: "You know the best table at the best restaurant 3 months before you land. Precision is your superpower.", destinations: [{ name: "Switzerland", image: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=400&q=80" }, { name: "Singapore", image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=400&q=80" }, { name: "Vienna, Austria", image: "https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=400&q=80" }], colors: ["#1E40AF", "#3B82F6"] },
  solo: { title: "Solo Adventurer", iconName: "figure.walk", description: "You travel on your own terms. Every decision is yours, every discovery is personal.", destinations: [{ name: "Japan", image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=400&q=80" }, { name: "Iceland", image: "https://images.unsplash.com/photo-1476610182048-b716b8518aae?w=400&q=80" }, { name: "New Zealand", image: "https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=400&q=80" }], colors: ["#7C3AED", "#A855F7"] },
  default: { title: "Free Spirit Traveler", iconName: "globe", description: "You defy categories. Every trip is different, every destination a new chapter.", destinations: [{ name: "Lisbon, Portugal", image: "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=400&q=80" }, { name: "Chiang Mai, Thailand", image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&q=80" }, { name: "Cape Town, South Africa", image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=400&q=80" }], colors: ["#7B2FBE", "#E91E8C"] },
};
          ...
          <View style={S.destSection}>
            ...
            {dnaProfile.destinations.map((dest, i) => (
              <TouchableOpacity key={i} style={S.destCard} activeOpacity={0.85}
                ...
                <Image source={{ uri: dest.image }} style={S.destCardImg} contentFit="cover" />
