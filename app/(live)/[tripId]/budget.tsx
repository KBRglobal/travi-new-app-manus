...
const CATEGORIES = [
  { icon: '🏨', name: 'Accommodation', spent: 445, budget: 500, pct: 89 },
  { icon: '🍜', name: 'Food', spent: 180, budget: 200, pct: 90 },
  { icon: '🚗', name: 'Transport', spent: 95, budget: 150, pct: 63 },
  { icon: '🎯', name: 'Activities', spent: 127, budget: 400, pct: 32 },
  { icon: '🛍️', name: 'Shopping', spent: 0, budget: 250, pct: 0 },
];
          ...
          <TouchableOpacity key={cat.name} className="bg-bg-card rounded-card p-4 mb-2">
            <View className="flex-row items-center justify-between mb-2">
              ...
              <View className="flex-row items-center">
                ...
                <Text className={`ml-2 ${cat.pct >= 80 ? 'text-yellow-400' : 'text-green-400'}`}>{cat.pct >= 80 ? '⚠️' : '✓'}</Text>
              </View>
            </View>
