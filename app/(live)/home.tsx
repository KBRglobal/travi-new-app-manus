...
const EMERGENCY_CONTACTS = [
  ...
  { label: "Ambulance", number: "15", emoji: "🚑" },
  { label: "Fire Brigade", number: "18", emoji: "🚒" },
  { label: "Embassy", number: "+33 1 43 12 22 22", emoji: "🏛️" },
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.weatherDetails}>
          ...
          <Text style={styles.weatherTitle}>🌤️ Weather in {activeTrip?.destination}</Text>
          <View style={styles.weatherGrid}>
            {[
              { label: "Temperature", value: WEATHER.temp, icon: "🌡️" },
          ...
          <View style={styles.modalContent}>
            ...
            {EMERGENCY_CONTACTS.map((c) => (
              <TouchableOpacity key={c.label} style={styles.emergencyItem} activeOpacity={0.8}>
                ...
                <Text style={styles.emergencyEmoji}>{c.emoji}</Text>
...
const styles = StyleSheet.create({
  ...
  liveText: { color: "#4CAF50", fontSize: 13, fontWeight: "800", letterSpacing: 1 },
  moreBtn: {},
  ...
  heroDestination: { color: "#FFFFFF", fontSize: 32, fontWeight: "900", letterSpacing: -0.5 },
  heroCountry: { color: "rgba(255,255,255,0.6)", fontSize: 16, marginTop: 2 },
  weatherCard: { backgroundColor: "rgba(255,255,255,0.1)", borderRadius: 16, padding: 12, alignItems: "center", gap: 2, borderWidth: 1, borderColor: "rgba(255,255,255,0.15)" },
  weatherIcon: { fontSize: 24 },
  weatherTemp: { color: "#FFFFFF", fontSize: 18, fontWeight: "800" },
  ...
  currentTimeText: { color: "#C4B5D9", fontSize: 13, fontWeight: "700" },
  ...
  currentTitle: { color: "#FFFFFF", fontSize: 20, fontWeight: "800" },
  ...
  dirBtnText: { color: "#FFFFFF", fontSize: 14, fontWeight: "700" },
  askBtn: { flex: 1, borderRadius: 14, borderWidth: 1.5, borderColor: "rgba(123,47,190,0.5)", alignItems: "center", justifyContent: "center", paddingVertical: 12 },
  askBtnText: { color: "#C4B5D9", fontSize: 14, fontWeight: "600" },
  ...
  nextTimeText: { color: "#FFFFFF", fontSize: 13, fontWeight: "700" },
  nextInfo: { flex: 1 },
  nextTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  nextLocation: { color: "#5A4D72", fontSize: 12, marginTop: 2 },
  ...
  tipIcon: { fontSize: 22 },
  tipTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  ...
  weatherItemIcon: { fontSize: 22 },
  weatherItemValue: { color: "#FFFFFF", fontSize: 14, fontWeight: "700" },
  ...
  pointsValue: { color: "#FFD700", fontSize: 22, fontWeight: "800" },
  ...
  modalSub: { color: "#8B7AAA", fontSize: 14 },
  ...
  emergencyLabel: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  emergencyNumber: { color: "#F44336", fontSize: 18, fontWeight: "800", marginTop: 2 },
  callBtn: { backgroundColor: "rgba(244,67,54,0.2)", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: "rgba(244,67,54,0.4)" },
  callBtnText: { color: "#F44336", fontSize: 13, fontWeight: "700" },
});
