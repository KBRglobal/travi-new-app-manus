...
export default function PointsDashboard() {
 ...
 const quickNav = [
 { iconName: 'gift', label: 'Redeem', route: '/(trip)/points/redeem' },
 { iconName: 'diamond', label: 'Earn', route: '/(trip)/points/earn' },
 { icon: 'document-text', label: 'History', route: '/(trip)/points/history' },
 { icon: '', label: 'Perks', route: '/(trip)/points/perks' },
 { iconName: 'people', label: 'Referrals', route: '/(trip)/points/referrals' },
