...
const styles = StyleSheet.create({
  ...
  menuCategoryTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 10, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.08)", fontFamily: "Chillax-Bold" },
