...
const TIERS = [
  ...
  { name: "Gold", emoji: "🥇", minXP: 5000, maxXP: 10000, cashbackRate: "12%", color: "#FFD700", perks: ["12% cashback on all bookings", "Free travel insurance (unlimited)", "Lounge access (unlimited)", "Room upgrades when available", "DNA-matched concierge"] },
          ...
          renderItem={({ item: reward }) => (
            <View style={[styles.rewardCard, !reward.available && { opacity: 0.5 }]}>
              ...
              <View style={styles.rewardRight}>
                ...
                <TouchableOpacity
                  style={[styles.redeemBtn, redeeming === reward.id && styles.redeemBtnSuccess, !reward.available && { backgroundColor: "rgba(255,255,255,0.05)" }]}
...
const styles = StyleSheet.create({
  ...
  balanceCard: { flex: 1, borderRadius: 18, overflow: "hidden", padding: 14, alignItems: "center", gap: 4, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  balanceEmoji: { fontSize: 24 },
  balanceValue: { color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  ...
  balanceBtnText: { color: "#FFFFFF", fontSize: 12, fontWeight: "800" },
  ...
  tierCard: { borderRadius: 18, overflow: "hidden", padding: 16, marginBottom: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", gap: 12 },
  tierHeader: { flexDirection: "row", alignItems: "center", gap: 12 },
  tierEmoji: { fontSize: 32 },
  tierInfo: { flex: 1 },
  tierName: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" },
  tierXP: { color: "rgba(255,255,255,0.5)", fontSize: 13 },
  tierNext: { color: "rgba(255,255,255,0.4)", fontSize: 11, textAlign: "right" },
  tierProgress: { gap: 6 },
  tierProgressTrack: { height: 8, backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 4, overflow: "hidden" },
  tierProgressFill: { height: 8, borderRadius: 4 },
  tierProgressLabel: { color: "rgba(255,255,255,0.3)", fontSize: 10 },
  ...
  perkDot: { fontSize: 14, fontWeight: "900", marginTop: 1 },
  perkText: { color: "rgba(255,255,255,0.7)", fontSize: 14, flex: 1, lineHeight: 20 },
  tierRow: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "rgba(255,255,255,0.03)", borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  tierRowEmoji: { fontSize: 22 },
  tierRowInfo: { flex: 1 },
  tierRowName: { color: "#FFFFFF", fontSize: 14, fontWeight: "700" },
  tierRowXP: { color: "rgba(255,255,255,0.4)", fontSize: 12 },
  tierRowRate: { fontSize: 16, fontWeight: "900" },
  ...
  referTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", textAlign: "center" },
  referDesc: { color: "rgba(255,255,255,0.5)", fontSize: 13, textAlign: "center", lineHeight: 20 },
  ...
  referCode: { color: "#FFFFFF", fontSize: 16, fontWeight: "900", flex: 1, letterSpacing: 1 },
  ...
  redeemList: { paddingHorizontal: 20, paddingBottom: 40, gap: 10 },
  rewardCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 16, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  rewardEmoji: { fontSize: 28 },
  rewardInfo: { flex: 1, gap: 3 },
  rewardTitle: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  rewardPoints: { color: "#C084FC", fontSize: 13, fontWeight: "900" },
  rewardFree: { color: "#22C55E", fontSize: 13, fontWeight: "900" },
  ...
  historyList: { paddingHorizontal: 20, paddingBottom: 40, gap: 8 },
  txRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
