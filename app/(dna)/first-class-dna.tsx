...
const styles = StyleSheet.create({
  ...
  headerProgress: { color: "rgba(255,255,255,0.4)", fontSize: 13, fontWeight: "700" },
  ...
  introTitle: { color: "#FFFFFF", fontSize: 28, fontWeight: "900", textAlign: "center", marginBottom: 8 },
  introSub: { color: "rgba(255,255,255,0.6)", fontSize: 15, textAlign: "center", lineHeight: 22 },
  ...
  introStatLabel: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 2 },
  introStatSub: { color: "rgba(255,255,255,0.5)", fontSize: 11, textAlign: "center" },
  introModules: { marginHorizontal: 20, marginBottom: 24 },
  introModulesTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", marginBottom: 14 },
  introModuleRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 10 },
  introModuleDot: { width: 8, height: 8, borderRadius: 4 },
  introModuleName: { color: "#FFFFFF", fontSize: 14, fontWeight: "700", width: 80 },
  introModuleDesc: { color: "rgba(255,255,255,0.5)", fontSize: 13, flex: 1 },

  // Modules list
  modulesHeader: { paddingHorizontal: 20, paddingTop: 16, paddingBottom: 12 },
  modulesTitle: { color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  modulesSub: { color: "rgba(255,255,255,0.5)", fontSize: 14, marginTop: 4 },
  ...
  moduleCardName: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
  moduleCardSub: { color: "rgba(255,255,255,0.5)", fontSize: 13, marginTop: 2 },
  ...
  moduleStatusText: { color: "rgba(255,255,255,0.6)", fontSize: 13, fontWeight: "800" },
  ...
  moduleHeaderName: { fontSize: 16, fontWeight: "800" },
  moduleHeaderSub: { color: "rgba(255,255,255,0.5)", fontSize: 13 },

  // Question
  questionWrap: { paddingHorizontal: 20, paddingTop: 8 },
  questionText: { color: "#FFFFFF", fontSize: 20, fontWeight: "800", lineHeight: 28, marginBottom: 20 },
  optionsWrap: { gap: 12 },
  ...
  optionCheckText: { color: "#FFFFFF", fontSize: 12, fontWeight: "900" },
  optionLabel: { color: "rgba(255,255,255,0.85)", fontSize: 15, lineHeight: 21, flex: 1 },

  // Result
  resultHero: { margin: 20, borderRadius: 24, overflow: "hidden", padding: 28, alignItems: "center" },
  resultEmoji: { fontSize: 56, marginBottom: 12 },
  resultTitle: { color: "#FFFFFF", fontSize: 26, fontWeight: "900", textAlign: "center", marginBottom: 6 },
  resultSub: { color: "rgba(255,255,255,0.7)", fontSize: 16, textAlign: "center", lineHeight: 22, marginBottom: 16 },
  ...
  resultSectionTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", marginBottom: 4 },
  resultSectionSub: { color: "rgba(255,255,255,0.4)", fontSize: 13, marginBottom: 14 },
  ...
  dimensionLabel: { color: "rgba(255,255,255,0.85)", fontSize: 13, fontWeight: "700" },
  ...
  dimensionScore: { fontSize: 14, fontWeight: "900", width: 32, textAlign: "right" },
  insightCards: { gap: 10 },
  ...
  insightText: { flex: 1, color: "rgba(255,255,255,0.7)", fontSize: 14, lineHeight: 20 },
