...
const T = StyleSheet.create({
  ...
  chartValue: { color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  chartTrend: { color: "#22C55E", fontSize: 13, fontWeight: "700" },

  revCard: { borderRadius: 18, overflow: "hidden", padding: 16, borderWidth: 1, borderColor: "rgba(100,67,244,0.2)", gap: 10 },
  revTotal: { color: "#FFFFFF", fontSize: 28, fontWeight: "900" },
  ...
  revValue: { color: "#FFFFFF", fontSize: 13, fontWeight: "700", width: 70, textAlign: "right" },

  trendStats: { flexDirection: "row", gap: 10 },
  trendStat: { flex: 1, alignItems: "center", gap: 2 },
  trendStatValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  ...
  compName: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
  ...
  commValue: { color: "#FFFFFF", fontSize: 13, fontWeight: "700", marginTop: 2 },
  ...
  regFlag: { fontSize: 24 },
  regCountry: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", flex: 1 },
