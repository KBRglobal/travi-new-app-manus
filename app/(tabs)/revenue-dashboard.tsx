...
const styles = StyleSheet.create({
  ...
  headerLabel: { fontSize: 10, fontWeight: "700", color: "#6443F4", letterSpacing: 2, marginBottom: 2 },
  ...
  periodText: { fontSize: 12, fontWeight: "600", color: "#9BA1A6" },
  ...
  tabText: { fontSize: 11, fontWeight: "600", color: "#9BA1A6" },
  ...
  kpiValue: { fontSize: 20, fontWeight: "800", color: "#ECEDEE" },
  kpiLabel: { fontSize: 11, color: "#9BA1A6", marginTop: 2 },
  ...
  chartTitle: { fontSize: 16, fontWeight: "700", color: "#ECEDEE" },
  chartSub: { fontSize: 12, color: "#9BA1A6", marginTop: 2, marginBottom: 16 },

  barChart: {
    flexDirection: "row", alignItems: "flex-end", gap: 8, height: 160,
  },
  barWrapper: { flex: 1, alignItems: "center", gap: 4 },
  barValue: { fontSize: 9, color: "#9BA1A6", fontWeight: "600" },
  barTrack: { flex: 1, width: "100%", justifyContent: "flex-end" },
  bar: { width: "100%", borderRadius: 4 },
  barMonth: { fontSize: 10, color: "#9BA1A6", fontWeight: "600" },
  barGrowth: { fontSize: 8, fontWeight: "700" },
  ...
  summaryValue: { fontSize: 16, fontWeight: "800", color: "#6443F4" },
  summaryLabel: { fontSize: 10, color: "#9BA1A6", marginTop: 2, textAlign: "center" },
  ...
  legendLabel: { fontSize: 13, color: "#ECEDEE", flex: 1 },
  legendRight: { flexDirection: "row", alignItems: "center", gap: 12 },
  legendTrend: { fontSize: 11, fontWeight: "700" },
  legendPct: { fontSize: 12, color: "#9BA1A6", width: 30, textAlign: "right" },
  legendValue: { fontSize: 13, fontWeight: "700", color: "#ECEDEE", width: 44, textAlign: "right" },
  ...
  insightTitle: { fontSize: 14, fontWeight: "700", color: "#F59E0B" },
  insightText: { fontSize: 13, color: "#9BA1A6", lineHeight: 20 },
  ...
  destRankText: { fontSize: 10, fontWeight: "800", color: "#6443F4" },
  destFlag: { fontSize: 22 },
  destInfo: { flex: 1 },
  destCity: { fontSize: 14, fontWeight: "700", color: "#ECEDEE" },
  destBookings: { fontSize: 11, color: "#9BA1A6", marginTop: 1 },
  destRevenue: { alignItems: "flex-end", marginRight: 8 },
  destRevenueValue: { fontSize: 14, fontWeight: "700", color: "#ECEDEE" },
  destGrowth: { fontSize: 11, fontWeight: "600" },
  destBarTrack: {
  ...
  geoPct: { fontSize: 16, fontWeight: "800" },
  geoLabel: { fontSize: 10, color: "#9BA1A6", textAlign: "center", maxWidth: 70 },
});
