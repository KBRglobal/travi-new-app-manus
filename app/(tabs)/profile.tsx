...
const styles = StyleSheet.create({
  ...
  userEmail: { color: "rgba(255,255,255,0.55)", fontSize: 14, fontFamily: "Satoshi-Regular" },
  ...
  xpProgressBg: { height: 6, backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 3, overflow: "hidden" },
  ...
  statsRow: { flexDirection: "row", width: "100%", borderRadius: 20, overflow: "hidden", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.15)", backgroundColor: "rgba(255,255,255,0.06)" },
  statItem: { flex: 1, alignItems: "center", paddingVertical: 16, gap: 4 },
  statDivider: { position: "absolute", left: 0, top: 12, bottom: 12, width: 1, backgroundColor: "rgba(255,255,255,0.15)" },
  statValue: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", fontFamily: "Chillax-Bold" },
  statLabel: { color: "rgba(255,255,255,0.6)", fontSize: 11, fontFamily: "Satoshi-Regular" },
  section: { gap: 14 },
  ...
  dnaBadgeGradient: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.15)" },
  dnaBadgeText: { fontSize: 13, fontWeight: "600", fontFamily: "Satoshi-Medium" },
  achCard: { width: 120, borderRadius: 18, padding: 14, gap: 6, alignItems: "center", overflow: "hidden", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.15)" },
  achCardLocked: { borderColor: "rgba(255,255,255,0.1)" },
  ...
  achDesc: { color: "rgba(255,255,255,0.45)", fontSize: 10, textAlign: "center", lineHeight: 14, fontFamily: "Satoshi-Regular" },
  ...
  proCircle1: { position: "absolute", width: 120, height: 120, borderRadius: 60, top: -30, right: -20, backgroundColor: "rgba(255,255,255,0.05)" },
  proCircle2: { position: "absolute", width: 80, height: 80, borderRadius: 40, bottom: -20, left: 20, backgroundColor: "rgba(255,255,255,0.05)" },
  ...
  settingsGroup: { borderRadius: 20, overflow: "hidden", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.12)", backgroundColor: "rgba(255,255,255,0.05)" },
  settingsRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 14, gap: 14 },
  settingsRowBorder: { borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.1)" },
  ...
  settingsValue: { color: "rgba(255,255,255,0.5)", fontSize: 14, fontFamily: "Satoshi-Regular" },
  ...
  // DNA Traits
  dnaTraitsCard: { borderRadius: 20, overflow: "hidden", borderWidth: 1.5, borderColor: "rgba(255,255,255,0.12)", backgroundColor: "rgba(255,255,255,0.05)", padding: 16, gap: 12 },
  ...
  traitTrack: { height: 6, backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 3, overflow: "hidden" },
  ...
  dnaEmptySub: { color: "rgba(255,255,255,0.5)", fontSize: 13, textAlign: "center", lineHeight: 18, fontFamily: "Satoshi-Regular" },
