...
const S = StyleSheet.create({
  ...
  headerTitle: { flex: 1, color: "#1A0B2E", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold", textAlign: "center" },
  ...
  heroTitle: { color: "#1A0B2E", fontSize: 20, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  inviteName: { color: "#1A0B2E", fontSize: 14, fontWeight: "800", fontFamily: "Chillax-Bold" },
  ...
  statusText: { fontSize: 11, fontWeight: "800",
      fontFamily: "Chillax-Bold", color: "#1A0B2E" },
  ...
  input: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", paddingHorizontal: 14, paddingVertical: 12, color: "#1A0B2E", fontSize: 14 },
  textarea: { height: 100, paddingTop: 12 },
  sendBtn: { marginTop: 16, borderRadius: 14, backgroundColor: "#6443F4", paddingVertical: 16, alignItems: "center" },
  sendBtnText: { color: "#1A0B2E", fontSize: 15, fontWeight: "900", fontFamily: "Chillax-Bold" },
