...
const S = StyleSheet.create({
  ...
  inviteCard: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.55)" },
  ...
  input: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", paddingHorizontal: 14, paddingVertical: 12, color: "#FFFFFF", fontSize: 14 },
  ...
  linkCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)", paddingHorizontal: 14, paddingVertical: 12 },
