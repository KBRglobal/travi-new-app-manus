...
const DOCUMENTS = [
  ...
  { id: '2', emoji: '📋', title: 'Japan eVisa', status: 'Approved', detail: 'Valid Apr 10 - May 10', color: 'text-green-400' },
  { id: '3', emoji: '🏥', title: 'Travel Insurance', status: 'Active', detail: 'World Nomads • Policy #WN-12345', color: 'text-green-400' },
  { id: '4', emoji: '✈️', title: 'Flight Ticket', status: 'Confirmed', detail: 'AA 123 • Apr 15, 10:30 AM', color: 'text-green-400' },
  { id: '5', emoji: '🏨', title: 'Hotel Booking', status: 'Confirmed', detail: 'Hotel Shinjuku • 7 nights', color: 'text-green-400' },
