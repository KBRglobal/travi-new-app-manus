...
const styles = StyleSheet.create({
  ...
  progressTrack: { height: 4, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 2 },
  ...
  stepHeader: { alignItems: "center", paddingTop: 16, paddingBottom: 130, gap: 10 },
  ...
  sliderDot: { width: 20, height: 20, borderRadius: 10, backgroundColor: "rgba(255,255,255,0.55)" },
