...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: "row", marginHorizontal: 20, marginTop: 16, backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, padding: 4 },
  ...
  catChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  addItemInput: { flex: 1, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, color: "#FFFFFF", fontSize: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  addItemBtnText: { color: "#FFFFFF", fontSize: 24, fontWeight: "700" },
  checkItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 12, paddingHorizontal: 14, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 14, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  checkItemDone: { opacity: 0.5 },
  checkBox: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center", marginTop: 1 },
  ...
  checkItemTextDone: { textDecorationLine: "line-through", color: "rgba(255,255,255,0.4)" },
  ...
  serviceCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  serviceIconWrap: { width: 48, height: 48, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  serviceIcon: { fontSize: 24 },
  serviceInfo: { flex: 1, gap: 3 },
  serviceTitle: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  totalCashbackAmount: { color: "#22C55E", fontSize: 28, fontWeight: "900", marginTop: 4 },
  // Visa
  ...
  visaDestination: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" },
  ...
  visaStatusText: { fontSize: 12, fontWeight: "800" },
  visaNote: { color: "rgba(255,255,255,0.65)", fontSize: 13, lineHeight: 20 },
  docItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.06)" },
  ...
  emergencyItem: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.06)" },
  emergencyLabel: { color: "rgba(255,255,255,0.7)", fontSize: 14, fontWeight: "600" },
  emergencyNumber: { color: "#6443F4", fontSize: 14, fontWeight: "800" },
});
