...
const styles = StyleSheet.create({
  ...
  amountCurrency: { color: "rgba(255,255,255,0.5)", fontSize: 24, fontWeight: "700", marginRight: 4 },
  amountInput: { flex: 1, color: "#FFFFFF", fontSize: 32, fontWeight: "900", paddingVertical: 16 },
  ...
  methodTitle: { color: "rgba(255,255,255,0.7)", fontSize: 14, fontWeight: "800" },
  ...
  methodFeeText: { fontSize: 11, fontWeight: "800" },
  ...
  confirmAmount: { color: "#FFFFFF", fontSize: 40, fontWeight: "900" },
  confirmMethod: { color: "rgba(255,255,255,0.5)", fontSize: 15 },
  ...
  successAmount: { color: "#22C55E", fontSize: 40, fontWeight: "900" },
