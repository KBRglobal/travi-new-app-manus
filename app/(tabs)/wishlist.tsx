...
const S = StyleSheet.create({
  ...
  headerTitle: { flex: 1, color: "#FFFFFF", fontSize: 22, fontWeight: "900" },
  headerCount: { color: "#A78BFA", fontSize: 16, fontWeight: "900" },
  ...
  cardPrice: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  planBtnText: { color: "#FFFFFF", fontSize: 12, fontWeight: "900" },
  empty: { paddingTop: 60, alignItems: "center", gap: 12 },
  emptyEmoji: { fontSize: 48 },
  emptyTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" },
  emptyDesc: { color: "rgba(255,255,255,0.4)", fontSize: 14, textAlign: "center", paddingHorizontal: 40 },
  emptyBtn: { marginTop: 8, borderRadius: 12, backgroundColor: "#6443F4", paddingHorizontal: 24, paddingVertical: 12 },
  emptyBtnText: { color: "#FFFFFF", fontSize: 14, fontWeight: "900" },
});
