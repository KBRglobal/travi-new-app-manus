...
export default function LiveSettingsScreen() {
 ...
 {[
 { key: 'locationSharing' as const, label: 'Location Sharing', desc: 'Share location with travel buddies', iconName: 'location' },
 { key: 'autoTranslate' as const, label: 'Auto Translate', desc: 'Translate signs and menus', emoji: '' },
 { key: 'offlineMaps' as const, label: 'Offline Maps', desc: 'Download maps for offline use', iconName: 'map' },
 { key: 'emergencyContacts' as const, label: 'Emergency Contacts', desc: 'Quick access to emergency numbers', iconName: 'alert-circle' },
 { key: 'currencyAutoDetect' as const, label: 'Auto Currency', desc: 'Detect local currency automatically', emoji: 'swap-horizontal' },
 { key: 'weatherAlerts' as const, label: 'Weather Alerts', desc: 'Get severe weather notifications', emoji: '' },
 { key: 'quietHours' as const, label: 'Quiet Hours', desc: 'Mute notifications 10PM-8AM', iconName: 'moon' },
