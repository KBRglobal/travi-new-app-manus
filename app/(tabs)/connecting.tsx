...
const S = StyleSheet.create({
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", gap: 10, marginHorizontal: 16, marginBottom: 12, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: RADIUS.xl, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  searchInput: { flex: 1, ...TYPE.body, color: BRAND.textPrimary },

  tabRow: { flexDirection: "row", paddingHorizontal: 16, gap: 8, marginBottom: 8 },
  tabBtn: { overflow: "hidden", flex: 1, borderRadius: RADIUS.full, paddingVertical: 9, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  tabBtnActive: { borderColor: "transparent" },
  tabBtnText: { ...TYPE.caption, color: BRAND.textSecondary },
  tabBtnTextActive: { color: "#FFF" },

  // Traveler card
  travelerCard: { overflow: "hidden", borderRadius: RADIUS.xl, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", padding: 14, gap: 10 },
  ...
  destChip: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: RADIUS.full, paddingHorizontal: 10, paddingVertical: 4 },
  destChipText: { ...TYPE.caption, color: BRAND.textSecondary },
  cardFooter: { flexDirection: "row", alignItems: "center", gap: 12 },
  footerItem: { flexDirection: "row", alignItems: "center", gap: 4 },
  footerText: { ...TYPE.caption, color: BRAND.textMuted },
  msgBtn: { marginLeft: "auto" as any, width: 32, height: 32, borderRadius: 16, backgroundColor: "rgba(255,255,255,0.06)", alignItems: "center", justifyContent: "center" },

  // Request card
  requestCard: { overflow: "hidden", borderRadius: RADIUS.xl, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", padding: 14, gap: 12 },
  ...
  declineBtn: { flex: 1, borderRadius: RADIUS.xl, paddingVertical: 10, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  dnaMatchBarWrap: { flex: 1, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.06)", overflow: "hidden" },
  ...
  activityPill: { backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
