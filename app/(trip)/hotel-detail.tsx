...
const styles = StyleSheet.create({
  ...
  highlightChip: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 10, padding: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  roomCard: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.55)", position: "relative" },
  ...
  perkChip: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
