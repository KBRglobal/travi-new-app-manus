...
export default function ProfileScreen() {
  ...
  const menuItems = [
    { icon: '✈️', label: 'My Trips', route: '/(tabs)/home/trips' },
    { icon: '🗺️', label: 'Adventure Log', route: '/(trip)/profile/adventure-log', isNew: true },
    { icon: '💰', label: 'Wallet', route: '/(tabs)/wallet' },
    { icon: '⭐', label: 'Points & Rewards', route: '/(tabs)/points' },
    { icon: '🧬', label: 'Travel DNA', route: '/(trip)/dna/results' },
    { icon: '👥', label: 'Social', route: '/(tabs)/social' },
    { icon: '⚙️', label: 'Settings', route: '/(trip)/settings' },
    { icon: '❓', label: 'Help & Support', route: '/(trip)/settings/help' },
  ];
