...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 10, alignItems: "center", gap: 2, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  statEmoji: { fontSize: 18 },
  statValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  memoryTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  memoryTag: { backgroundColor: "rgba(255,255,255,0.55)", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  memoryTagText: { color: "rgba(255,255,255,0.8)", fontSize: 10, fontWeight: "700" },
  statsContent: { paddingHorizontal: 20, paddingTop: 8 },
  statsTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", marginBottom: 12, fontFamily: "Chillax-Bold" },
  bigStatCard: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
  ...
  moodBarWrap: { flex: 1, height: 8, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 4, overflow: "hidden" },
  ...
  mapTitle: { color: "#FFFFFF", fontSize: 20, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  mapPin: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8, alignItems: "center", gap: 4 },
  ...
  detailTitle: { color: "#FFFFFF", fontSize: 24, fontWeight: "900", fontFamily: "Chillax-Bold" },
  ...
  detailMetaCard: { flex: 1, backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 12, alignItems: "center", gap: 4 },
  detailMetaValue: { color: "#FFFFFF", fontSize: 13, fontWeight: "800", fontFamily: "Chillax-Bold" },
  detailMetaLabel: { color: "rgba(255,255,255,0.5)", fontSize: 11 },
  detailSectionTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", marginBottom: 10, fontFamily: "Chillax-Bold" },
  ...
  notesCard: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 14, padding: 14, marginBottom: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.55)" },
