...
const S = StyleSheet.create({
  ...
  inviteTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  ...
  inviteBtnText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  ...
  companionName: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
  ...
  splitTotal: { color: "#FFFFFF", fontSize: 40, fontWeight: "900" },
  ...
  splitPerPerson: { color: "#6443F4", fontSize: 28, fontWeight: "900" },
  ...
  splitItemPer: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" },
